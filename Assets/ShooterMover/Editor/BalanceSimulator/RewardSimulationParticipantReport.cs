...
{
    public sealed class RewardSimulationParticipantReport :
        IComparable<RewardSimulationParticipantReport>
    {
        private readonly ReadOnlyDictionary<StableId, long> strongboxTierCounts;
        private readonly string canonicalText;

        public RewardSimulationParticipantReport(
            ...
            ParticipantDropPacingState finalPacingState)
        {
        ...
        public ParticipantDropPacingState FinalPacingState { get; }
            ...
            get
            {
                return SourceAttempts == 0L
                    ...
                    : (double)RawStrongboxProbabilityMillionthsTotal
                        / SourceAttempts
                        / RunDropPacingPolicy.ProbabilityScale;
            }
        }
        ...
        public int CompareTo(RewardSimulationParticipantReport other)
        {

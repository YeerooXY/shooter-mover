...
{
    public sealed class RewardSimulationReport
    {
        private readonly ReadOnlyCollection<RewardSimulationParticipantReport>
            participantReports;
        private readonly string canonicalText;

        public RewardSimulationReport(
            ...
            int sampleCount,
            ulong seed,
            IEnumerable<RewardSimulationParticipantReport> participantReports,
        ...
        public IReadOnlyList<RewardSimulationParticipantReport> ParticipantReports
        {
        ...
        private static ReadOnlyCollection<RewardSimulationParticipantReport>
            CopyReports(
                IEnumerable<RewardSimulationParticipantReport> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            }
            var copy = new List<RewardSimulationParticipantReport>();
            var ids = new HashSet<StableId>();
            foreach (RewardSimulationParticipantReport value in source)
            {
            ...
            return new ReadOnlyCollection<RewardSimulationParticipantReport>(copy);
        }
    }
}

...
namespace ShooterMover.Editor.BalanceSimulator
{
    ...
    /// composes StrongboxOpeningActions, production reward generation, the hybrid
    ...
    /// </summary>
    public sealed class AuthoritativeStrongboxSimulationGateway :
        IStrongboxSimulationGateway
    {
        ...
        private AuthoritativeStrongboxSimulatorLive chunkRuntime;
        private IReadOnlyList<AuthoritativeStrongboxPreparedOpen> chunkOpenings =
            Array.Empty<AuthoritativeStrongboxPreparedOpen>();
        ...
        public StrongboxFingerprints Fingerprints { get; }
            ...
            out string diagnostic)
        {
            ...
            AuthoritativeStrongboxPreparedOpen opening = chunkOpenings[localIndex];
            ...
            StrongboxAugmentSignature replayedSignature;
            try
            {
                policy = StrongboxHybridLootCatalog.GetByTierNumber(
                    tierNumber);
            ...
            out int tierNumber)
        {
            ...
            {
                StrongboxTier tier = tiers[index];
        ...
        {
            string fingerprint = Strongbox.Fingerprint(
        ...
        private static string BuildObservationFingerprint(
            StrongboxSimulationScenario scenario,
            long ordinal,
            AuthoritativeStrongboxPreparedOpen opening,

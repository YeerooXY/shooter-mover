...
{
    public static class LevelGridEditorOperations
    {
            ...
            bool automaticFacing)
        {
            ...
            if (root != null)
            {
                LevelGridDoorOperations.ReflowDoor(root, door);
            }
            ...
            out string rejection)
        {
            ...
            LevelGridDoorOperations.ReflowDoor(selectedRoot, source);
            LevelGridDoorOperations.ReflowDoor(selectedRoot, destination);
            Undo.CollapseUndoOperations(group);
            ...
            LevelGridValidationPurpose purpose)
        {
            ...
            LevelGridAuthoringLiveValidation.ValidateNow(root, purpose);

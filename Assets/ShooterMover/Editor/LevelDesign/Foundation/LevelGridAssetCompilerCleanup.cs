...
namespace ShooterMover.Editor.LevelDesign.Foundation
{
    public static partial class LevelGridAssetCompiler
    {
        ...
        private static List<string> SortedKeys(RoomContentJsonPackage package)
        {
        ...
        private static string ComputePackageVersionId(RoomContentJsonPackage package)
        {
        ...
        private static void Inject(
            ILevelGridAssetCompilerFaultInjector faultInjector,
            LevelGridAssetCompilerPublishStep step)
        {

...
{
    public sealed class LevelGridPlayableBuildResult
    {
    ...
    public static class LevelGridPlayableBuildFacade
    {
            ...
            LevelDesignSceneAuthoringRoot2D root)
        {
            ...
            try
            {
                LevelGridPlayableBuildPaths paths = ValidateOrThrow(root);
            ...
            LevelDesignSceneAuthoringRoot2D root)
        {
            ...
            try
            {
                LevelGridPlayableBuildPaths paths = ValidateOrThrow(root);
                result.ValidationPassed = true;
                LevelGridPlayableExporter.Export(
                    root,
            ...
            LevelDesignSceneAuthoringRoot2D root)
        {
            ...
            try
            {
                ...
                result.CompiledAsset = LevelGridAssetCompiler.CompileToAsset(
                    paths.SourcePackagePath,
        ...
        public static void RevealGeneratedFolder(LevelDesignSceneAuthoringRoot2D root)
        {
            LevelGridPlayableBuildPaths paths =
                LevelGridPlayableBuildPaths.Resolve(root);
            string absolute = LevelGridPlayableBuildPaths.ToAbsoluteProjectPath(
                paths.GeneratedAssetFolder);
        ...
        public static void OpenCatalogueSource()
        {
            MonoScript script = AssetDatabase.LoadAssetAtPath<MonoScript>(
                LevelGridPlayableBuildPaths.CatalogueSourcePath);
            if (script == null)
            {
                throw new InvalidOperationException(
            ...
            LevelDesignSceneAuthoringRoot2D root)
        {
            ...
            EditorSceneManager.OpenScene(
                LevelGridPlayableBuildPaths.LevelSelectionScenePath,

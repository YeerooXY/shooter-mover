...
{
    public static class LevelGridAuthoringJsonExporter
    {
        ...
        {
            ExportSelected(LevelGridValidationPurpose.Draft);
        }
        ...
        {
            ExportSelected(LevelGridValidationPurpose.ProductionPublish);
        }
        ...
        private static void ExportSelected(LevelGridValidationPurpose purpose)
        {
            ...
            LevelGridValidationResult gridValidation =
            ...
            if (purpose == LevelGridValidationPurpose.ProductionPublish
            ...
            LevelGridValidationPurpose purpose)
        {
            ...
            AuthoredMapNodeDto[] nodes = new AuthoredMapNodeDto[rooms.Length];
            ...
            for (int index = 0; index < rooms.Length; index++)
            {
                ...
                roomIndex[index] = new AuthoredRoomIndexDto
                {
                    room_id = room.RoomIdText,
                    grid_position = new[]
                    {
            ...
            MapConnectionDto[] mapConnections =
            ...
            string roomRoot)
        {
            ...
            AuthoredDoorDto[] roomDoors = new AuthoredDoorDto[count];
            int targetIndex = 0;
            for (int index = 0; index < allDoors.Length; index++)
            {
                ...
                roomDoors[targetIndex++] = new AuthoredDoorDto
                {
        ...
        private static LevelIdentityDto ReadLevelIdentity(string path)
        {
            ...
            try
            {
                LevelIdentityDto identity = JsonUtility.FromJson<LevelIdentityDto>(
        ...
        private static RoomIdentityDto ReadRoomIdentity(string path)
        {
            ...
            try
            {
                RoomIdentityDto identity = JsonUtility.FromJson<RoomIdentityDto>(
                    File.ReadAllText(path));
        ...
        [Serializable]
        private sealed class AuthoredLevelDto
        {
            ...
            public AuthoredRoomIndexDto[] rooms;
        }

        [Serializable]
        private sealed class AuthoredRoomIndexDto
        {
        ...
        [Serializable]
        private sealed class AuthoredMapDto
        {
            public int schema_version;
            public AuthoredMapNodeDto[] nodes;
            public MapConnectionDto[] connections;
        }

        [Serializable]
        private sealed class AuthoredMapNodeDto
        {
            public string room_id;
            public int[] grid_position;
            public int slot;
        ...
        private sealed class MapConnectionDto
        {
            ...
            public AuthoredEndpointDto from;
            public AuthoredEndpointDto to;
            public string travel_policy;
        }

        [Serializable]
        private sealed class AuthoredEndpointDto
        {
            public string room_id;
        ...
        [Serializable]
        private sealed class AuthoredRoomDto
        {
            public int schema_version;
            public string room_id;
        ...
        [Serializable]
        private sealed class AuthoredDoorsDto
        {
            public int schema_version;
            public string room_id;
            public AuthoredDoorDto[] doors;
        }

        [Serializable]
        private sealed class AuthoredDoorDto
        {
            public string door_id;
            public string side;
        ...
        [Serializable]
        private sealed class FloorScaffoldDto
        {
            public int schema_version;
            public string room;
            public string[] tiles;
        ...
        [Serializable]
        private sealed class EnemiesScaffoldDto
        {
            public int schema_version;
            public string room;
        ...
        [Serializable]
        private sealed class PropsScaffoldDto
        {
            public int schema_version;
            public string room;
            public string[] props;
        ...
        [Serializable]
        private sealed class DecorScaffoldDto
        {
            public int schema_version;
            public string room;
        ...
        [Serializable]
        private sealed class EncounterScaffoldDto
        {
            public int schema_version;
            public string room;

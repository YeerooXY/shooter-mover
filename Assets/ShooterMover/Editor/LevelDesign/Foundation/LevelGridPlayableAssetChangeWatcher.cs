...
namespace ShooterMover.Editor.LevelDesign.Foundation
{
    ...
    /// </summary>
    public sealed class LevelGridPlayableAssetChangeWatcher : AssetPostprocessor
    {
            ...
            LevelGridPlayableBuildPaths paths)
        {
            ...
            for (int index = 0; index < assetPaths.Length; index++)
            {
                ...
                if (string.Equals(
                    ...
                    || string.Equals(
                        path,
                        Normalize(LevelGridPlayableBuildPaths.CatalogueSourcePath),
                        StringComparison.Ordinal)

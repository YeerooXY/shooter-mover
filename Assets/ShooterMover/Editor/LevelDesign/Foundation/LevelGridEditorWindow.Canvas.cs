...
namespace ShooterMover.Editor.LevelDesign.Foundation
{
    public sealed partial class LevelGridEditorWindow : EditorWindow
    {
        ...
        private void DrawDoor(DoorEndpoint door)
        {
            ...
            string marker = door.PlacementMode == LevelDoorPlacementMode.Fixed
                ? "F"
            ...
            DoorLink link)
        {
            ...
            else if (room != null)
            {
                ...
                AddDoorSideMenu(menu, room, LevelDoorSide.North);
                AddDoorSideMenu(menu, room, LevelDoorSide.East);
                AddDoorSideMenu(menu, room, LevelDoorSide.South);
                AddDoorSideMenu(menu, room, LevelDoorSide.West);
                menu.AddSeparator(string.Empty);

...
{
    [Serializable]
    internal sealed class LevelGridPlayableProvenanceRecord
    {
    ...
    /// </summary>
    public static class LevelGridPlayableProvenance
    {
            ...
            string absolutePackageRoot)
        {
            ...
            var record = new LevelGridPlayableProvenanceRecord
            {
                schema_version = 1,
                compiler_schema_version = LevelGridCompiler.CurrentVersion,
            ...
            out int compilerSchemaVersion)
        {
            ...
            try
            {
                LevelGridPlayableProvenanceRecord record =
                    JsonUtility.FromJson<LevelGridPlayableProvenanceRecord>(
            ...
            LevelDraft root)
        {
            ...
            Append(canonical, "compiler", LevelGridCompiler.CurrentVersion.ToString(

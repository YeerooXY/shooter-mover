...
namespace ShooterMover.Tests.EditMode.LootDropBinding
{
    ...
    /// </summary>
    internal sealed class EnemyDeathLootDropFactBridge :
        ILootDropFactBridge
    {
        ...
        private readonly ContextResolvedEnemyDeathLootDropFactBridge inner;

        public EnemyDeathLootDropFactBridge(EnemyCatalog catalog)
        {
            inner = new ContextResolvedEnemyDeathLootDropFactBridge(

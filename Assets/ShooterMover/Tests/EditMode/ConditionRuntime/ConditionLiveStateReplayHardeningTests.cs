    ...
    public sealed partial class ConditionLiveStateTests
    {
        ...
        public void ExactDeliveryReplay_AfterLaterMutation_ReturnsStableOriginalSnapshot()
        {
            ...
            ConditionLiveState runtime = CreateRuntime(
                ...
                out ports);
            EnemyDeathFact deathA = Death("run.alpha", "a", 1, 1L);
            ports.CurrentTick = 1L;
            AcceptedGameplayFactDelivery deliveryA = Delivery(
                "delivery.a.1",
                deathA,
                "run.alpha",
                "a",
            ...
            ConditionFactIngestionResult first = runtime.Ingest(deliveryA);
            ConditionFactIngestionResult second =
                DeliverKill(runtime, ports, "a", 2, 3L);
            string currentFingerprint = second.Snapshot.Fingerprint;

            ConditionFactIngestionResult replayOne = runtime.Ingest(deliveryA);
            ConditionFactIngestionResult replayTwo = runtime.Ingest(deliveryA);
        ...
        public void ChangedUnsupportedFact_UnderSameDeliveryOperation_Conflicts()
        {
            ...
            ConditionLiveState runtime = CreateRuntime(
                ...
                out ports);
            ports.CurrentTick = 1L;
            AcceptedGameplayFactDelivery firstDelivery =
                UnsupportedDelivery(
                    "delivery.invalid",
                    new UnsupportedPayloadFact("payload-a"),
                    1L);
            AcceptedGameplayFactDelivery changedDelivery =
                UnsupportedDelivery(
                    "delivery.invalid",
                    new UnsupportedPayloadFact("payload-b"),
                    1L);

            ConditionFactIngestionResult first = runtime.Ingest(firstDelivery);
            ConditionFactIngestionResult conflict =
        ...
        public void ChangedInvalidEnemyDeath_WithSameDiagnostic_Conflicts()
        {
            ...
            EnemyDeathFact firstDeath = Death(
                "run.alpha",
                "a",
                1,
                1L,
                targetSuffix: "first-invalid");
            EnemyDeathFact changedDeath = Death(
                "run.alpha",
                "a",
                1,
                1L,
        ...
        public void Advance_TwoParticipantsWithRegressedClock_FailsBeforeAnyMutation()
        {
            ...
            ConditionLiveSnapshot before = runtime.Snapshot;
            ...
            ports.CurrentTick = 5L;
            ConditionLiveSnapshot afterFailure = runtime.Snapshot;
            ...
            ConditionLiveSnapshot accepted =
                runtime.Advance("advance.regressed");
        ...
        private static AcceptedGameplayFactDelivery UnsupportedDelivery(
            string operationId,

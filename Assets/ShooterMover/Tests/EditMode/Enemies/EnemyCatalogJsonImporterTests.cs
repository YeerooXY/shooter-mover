...
{
    public sealed class EnemyCatalogJsonImporterTests
    {
        [Test]
        public void AuthoredCatalogImportsAllFixturesAndCanonicalizesHybridPriority()
        {
            EnemyCatalogImportResult result = EnemyCatalogJsonImporter.Import(
                ReadAuthoredCatalog(),
                Registry());
            ...
            Assert.That(
                ...
                Is.EqualTo(EnemyAttackParameterKinds.Projectile | EnemyAttackParameterKinds.Area));
            Assert.That(Get(result, "enemy.pursuer-drone").MovementPolicyId, Is.EqualTo(Id("enemy-movement.pursuit")));

            EnemyDefinition hybrid = Get(result, "enemy.hybrid-sentinel");
        ...
        {
            EnemyCatalogImportResult known = Import(ProjectileDefinition(
                "enemy.fixture-alpha",
                "projectile.enemy-blaster"));
            EnemyCatalogImportResult unknown = Import(ProjectileDefinition(
                "enemy.fixture-alpha",
        ...
        {
            EnemyCatalogImportResult malformed = Import(ProjectileDefinition(
                "enemy.fixture-alpha",
                "Projectile Bad"));
            EnemyCatalogImportResult melee = ImportWithRegistry(
        ...
        {
            EnemyCatalogImportResult rangedFirst = Import(MixedDefinition(false));
            EnemyCatalogImportResult meleeFirst = Import(MixedDefinition(true));
            ...
            EnemyDefinition definition = rangedFirst.Catalog.Definitions[0];
        ...
        {
            EnemyCatalogImportResult arc = Import(ProjectileDefinition(
                "enemy.fixture-alpha", "projectile.enemy-blaster", 0d));
            EnemyCatalogImportResult detection = Import(ProjectileDefinition(
                "enemy.fixture-alpha", "projectile.enemy-blaster", 90d, 12d, 16d, 10, 10d));
            EnemyCatalogImportResult travel = Import(ProjectileDefinition(
                "enemy.fixture-alpha", "projectile.enemy-blaster", 90d, 12d, 8d));
            EnemyCatalogImportResult reach = Import(MeleeDefinition(
                "enemy.fixture-alpha", 2d, 0.8d, 0d));
            EnemyCatalogImportResult priority = Import(MixedDefinition(false, 10));
        ...
        public void DuplicateDefinitionsAndUnknownBehaviorReferencesFailClosed()
        {
            ...
            EnemyCatalogImportResult duplicate = Import(definition, definition);
            EnemyCatalogImportResult movement = Import(definition.Replace(
                "enemy-movement.mobile-positioning",
                "enemy-movement.unknown"));
            EnemyCatalogImportResult capability = Import(definition.Replace(
        ...
        {
            EnemyCatalogImportResult narrow = Import(ProjectileDefinition(
                "enemy.fixture-alpha", "projectile.enemy-blaster", 60d));
            EnemyCatalogImportResult wide = Import(ProjectileDefinition(
        ...
        public void DefinitionOrderDoesNotAffectCatalogFingerprint()
        {
            ...
            EnemyCatalogImportResult first = Import(alpha, beta);
            EnemyCatalogImportResult second = Import(beta, alpha);
        ...
        {
            EnemyCatalogImportResult extension = Import(ProjectileDefinition(
                "enemy.fixture-scout",
                "projectile.enemy-blaster",
                90d,
                12d,
            ...
            EnemyCatalogImportResult presentation = Import(ProjectileDefinition(
                "enemy.fixture-alpha",
                "projectile.enemy-blaster",
                90d,
                12d,
            ...
            EnemyCatalogImportResult shape = Import(ProjectileDefinition(
                "enemy.fixture-alpha",
                "projectile.enemy-blaster",
                90d,
                12d,
        ...
        private static EnemyCatalogImportResult Import(params string[] definitions)
        {
            return ImportWithRegistry(Registry(), definitions);
        }

        private static EnemyCatalogImportResult ImportWithRegistry(
            EnemyCatalogRegistry registry,
        ...
        private static EnemyCatalogRegistry Registry(string[] projectileProfiles)
        {
            return new EnemyCatalogRegistry(
                ...
                new[]
                {
                    ...
                    Attack("enemy-attack.projectile-area", EnemyAttackParameterKinds.Projectile | EnemyAttackParameterKinds.Area),
        ...
        private static EnemyDefinition Get(EnemyCatalogImportResult result, string definitionId)
        {
        ...
        private static void AssertIssue(EnemyCatalogImportResult result, string code)
        {

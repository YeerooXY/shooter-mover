...
namespace ShooterMover.Tests.EditMode.Enemies
{
    ...
    {
        private sealed class LiveRunTimeStub : IEnemyAttackPatternRunTime
        {
        ...
        {
            public readonly List<EnemyAttackEffectEmission> Emitted =
        ...
        public void LiveScheduler_AcceptsCompleteSequenceAtomically_AndExactReplayDoesNotDuplicate()
        {
            ...
            var scheduler = new EnemyAttackPatternLiveScheduler(
                time,
                realizer);

            EnemyAttackPatternDispatchResult first =
                scheduler.Dispatch(dispatch);
            EnemyAttackPatternDispatchResult replay =
                scheduler.Dispatch(dispatch);
        ...
        {
            EnemyAttackSequenceDispatch first = LiveDispatch(
                Shooting(
                    "live-conflict",
                    2,
                    0.2d,
                ...
                "live-conflict",
                3d);
            EnemyAttackSequenceDispatch conflicting = LiveDispatch(
                Shooting(
                    "live-conflict",
                    2,
                    0.2d,
        ...
        public void LiveScheduler_VariableTickIntervalsProduceSameCanonicalEmissionOrder()
        {
            ...
            var coarse = new EnemyAttackPatternLiveScheduler(
                coarseTime,
                coarseRealizer);
            ...
            var fine = new EnemyAttackPatternLiveScheduler(
                fineTime,
                fineRealizer);
            ...
            {
                EnemyAttackEffectEmission previous =
                    fineRealizer.Emitted[index - 1];
                EnemyAttackEffectEmission current =
        ...
        public void LiveScheduler_DelayedBurstUsesCommittedAimAndSchemaScatterWithoutReroll()
        {
            ...
            {
                EnemyAttackEffectEmission emitted = realizer.Emitted[index];
                EnemyAttackEffectEmission authored = dispatch.Emissions[index];
        ...
        public void LiveScheduler_ConflictingCancellationRejectsWithoutMutation()
        {
            ...
            var first = new EnemyAttackSequenceCancellationFact(
                cancellationId,
                dispatch.Execution.Identity.EntityInstanceId,
                dispatch.Execution.LifecycleGeneration,
                10d,
                ...
                new StableId[0]);
            var conflicting = new EnemyAttackSequenceCancellationFact(
                cancellationId,
                dispatch.Execution.Identity.EntityInstanceId,
                dispatch.Execution.LifecycleGeneration,
                10.1d,
        ...
        private static EnemyAttackSequenceDispatch LiveDispatch(
            ...
            double occurredAtSeconds)
        {
            ...
            return new EnemyAttackSequenceDispatch(
                execution,
                sequence,

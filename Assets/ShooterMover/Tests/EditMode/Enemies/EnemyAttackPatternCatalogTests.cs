...
namespace ShooterMover.Tests.EditMode.Enemies
{
    public sealed partial class EnemyAttackPatternStateTests
    {
        ...
        public void AuthoredProductionCatalog_RemainsSchemaV1UntilScheduledConsumerCutover()
        {
            ...
            EnemyDefinition blaster = result.Catalog.GetDefinition(
            ...
            EnemyDefinition pounce = result.Catalog.GetDefinition(
        ...
        public void SchemaV2Fixture_UsesReplacementPatternsWithoutCuttingOverProductionContent()
        {
            ...
            EnemyDefinition ranged = result.Catalog.GetDefinition(
                Id("enemy.mobile-blaster-droid"));
            ...
            Assert.That(
                ...
                Is.EqualTo(EnemySequenceAimPolicy.LockAtSequenceStart));
        ...
        public void ReservedAimAndTerminalPolicies_RejectAtExactSchemaV2Paths()
        {
            ...
            EnemyCatalogImportResult shootingAim = EnemyCatalogJsonImporter.Import(
                ReplaceFirst(
                    authored,
                    "\"sequence_aim_policy\": \"lock-at-sequence-start\"",
                    "\"sequence_aim_policy\": \"reaim-each-shot\""),
                Registry());
            EnemyCatalogImportResult meleeAim = EnemyCatalogJsonImporter.Import(
                ReplaceFirst(
                    authored,
                    "\"aim_commit_policy\": \"lock-at-wind-up\"",
                    "\"aim_commit_policy\": \"track-until-active-window\""),
                Registry());
            EnemyCatalogImportResult terminal = EnemyCatalogJsonImporter.Import(
                ReplaceFirst(
                    authored,
        ...
        {
            EnemyAttackSequence single = Sequence(Shooting(
            ...
            EnemyAttackSequence burst = Sequence(Shooting(
            ...
            EnemyAttackSequence rapid = Sequence(Shooting(
            ...
            EnemyAttackSequence shotgun = Sequence(Shooting(
            ...
            var explosion = new EnemyAreaPayload(2.5d, 0d, 16);
            EnemyAttackSequence slowExplosive = Sequence(Shooting(

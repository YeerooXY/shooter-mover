...
{
    public sealed class EnemyLiveFoundationTests
    {
        [Test]
        public void SameDefinition_ProducesIndependentStableInstancesAndLifecycleGenerations()
        {
            EnemyLiveView first = Runtime("enemy-a", EnemyRoomClearRole.RequiredEnemy, 0L);
            EnemyLiveView second = Runtime("enemy-b", EnemyRoomClearRole.RequiredEnemy, 0L);
            EnemyLiveView restarted = Runtime("enemy-a", EnemyRoomClearRole.RequiredEnemy, 1L);
        ...
        {
            EnemyLiveView required = Runtime("required", EnemyRoomClearRole.RequiredEnemy, 0L);
            EnemyLiveView optional = Runtime("optional", EnemyRoomClearRole.OptionalEnemy, 0L);
            ...
            EnemyLiveView terminal = Project(killed.State, EnemyRoomClearRole.RequiredEnemy, 0L);
        ...
        {
            EnemyLiveView runtime = Runtime("attributed", EnemyRoomClearRole.RequiredEnemy, 3L);
        ...
        private static EnemyLiveView Runtime(
            string entity,
        ...
        private static EnemyLiveView Project(
            ...
            long generation)
        {
            return new EnemyLiveView(
                ...
                new EnemyDefinitionView(state.RoleId, Id("movement", "fixture"),

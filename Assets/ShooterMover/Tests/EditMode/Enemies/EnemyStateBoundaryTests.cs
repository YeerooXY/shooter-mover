...
{
    public sealed class EnemyFactoryTestsStateBoundaries
    {
        [Test]
        ...
        public void OldProjectile_RejectsAfterLifecycleRestart()
        {
            ...
            EnemyInstance restarted = fixture.CreateRuntime(2L);
        ...
        private static void Kill(EnemyInstance runtime, string operation)
        {
        ...
        private sealed class Fixture
        {
            ...
            public EnemyInstance CreateRuntime(long generation)
            {

...
{
    public sealed class EnemyPlacementLiveFactoryTests
    {
        [Test]
        public void TenRepeatedDefinitions_DeriveDistinctIndependentActorAndParticipantIdentities()
        {
            EnemyDefinition definition = Definition(
                ...
                360d,
                120d);
            EnemyPlacementLiveFactory factory = Factory(
                new[] { definition },
            ...
            {
                EnemyPlacementLiveInstance runtime = result.Runtimes[index];
        ...
        public void RangedTurretPursuitAndMelee_ExecuteThroughRegisteredCapabilitiesWithoutRuntimeSubclasses()
        {
            ...
            {
                EnemyPlacementLiveInstance runtime = factory.Create(
                ...
                Assert.That(runtime.GetType(), Is.EqualTo(typeof(EnemyPlacementLiveInstance)));
        ...
        public void MovementRealization_ConsumesPolicyIntentThroughRegisteredTypedBoundary()
        {
            ...
            EnemyLivePolicyRegistry policies = CustomPolicies(
                definition,
        ...
        public void MissingCapabilityRegistration_RejectsRoomAtomically()
        {
            ...
            Assert.That(result.Rejection,
                Is.EqualTo(EnemyPlacementLiveFactoryRejection.AttackCapabilityNotRegistered));
        ...
        public void LethalDamage_EmitsAttributedTerminalFactsAndDownstreamConsumersOnce()
        {
            ...
            EnemyPlacementLiveInstance optionalRuntime = factory.Create(
        ...
        public void Restart_PreservesDerivedIdentityRestoresStateAndRejectsStaleIntentAndProjectile()
        {
            ...
            EnemyPlacementLiveFactory factory = Factory(
                ...
                BuiltInEnemyLivePolicyRegistry.Create(),
                ports.Bundle);
            EnemyPlacementLiveInstance first = factory.Create(
            ...
            EnemyPlacementLiveInstance restarted = factory.Create(
        ...
        public void DifficultyScaling_IsTypedAndAppliedWithoutChangingEnemyDefinition()
        {
            ...
            EnemyPlacementLiveFactory factory = Factory(
                ...
                BuiltInEnemyLivePolicyRegistry.Create(),
                EnemyLiveDownstreamPorts.None());
            EnemyPlacementLiveInstance normal = factory.Create(
                Request("difficulty-normal", "difficulty", 5, 1L, 1d)).Runtime;
            EnemyPlacementLiveInstance hard = factory.Create(
        ...
        private static EnemyLivePolicyRegistry CustomPolicies(

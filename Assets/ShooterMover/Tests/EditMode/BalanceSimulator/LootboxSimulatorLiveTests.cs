...
namespace ShooterMover.Editor.BalanceSimulator.Tests
{
    public sealed partial class LootboxSimulatorLiveTests
    {
        ...
        {
            LootboxSimulatorLive runtime = CreateRuntime();

            LootboxGeneratedItem first =
                runtime.Generate(5, 30, 123456UL, 0);
            LootboxGeneratedItem replay =
                runtime.Generate(5, 30, 123456UL, 0);
            LootboxGeneratedItem second =
        ...
        {
            LootboxSimulatorLive runtime = CreateRuntime();
            LootboxGeneratedItem kept =
                runtime.Generate(1, 30, 8765UL, 0);
            LootboxGeneratedItem sold =
        ...
        public void AntimatterOddsExposeZeroInstalledAugmentsDeterministically()
        {
            ...
            LootboxOddsReport first =
                runtime.CalculateOdds(11, 30, 99UL, 64);
            LootboxOddsReport replay =
                runtime.CalculateOdds(11, 30, 99UL, 64);
        ...
        public void InvalidCatalogReturnsDiagnosticWithoutCreatingRuntime()
        {
            ...
            Assert.That(
                LootboxSimulatorLive.TryCreate(
                    "{}",
                    out runtime,
                    out diagnostic),
                Is.False);
        ...
        private static LootboxSimulatorLive CreateRuntime()
        {
            ...
            string catalogJson)
        {
            LootboxSimulatorLive runtime;
            string diagnostic;
            bool created = LootboxSimulatorLive.TryCreate(
                catalogJson,
                out runtime,
                out diagnostic);

...
{
    public sealed class WeaponMountPolicyTests
    {
        [Test]
        public void ProductionClassesExposeOnlyTheirPhysicalMounts()
        {
            WeaponMountLayout aggressive = Layout(
                WeaponMountPolicy.AggressiveLoadoutProfileId);
            WeaponMountLayout healer = Layout(
                WeaponMountPolicy.HealerLoadoutProfileId);
            WeaponMountLayout defensive = Layout(
        ...
        public void UnknownProfilesFailClosedInsteadOfReceivingDefensiveMounts()
        {
            ...
            Assert.That(
                () => WeaponMountPolicy.ResolveLayout(null),
                Throws.ArgumentException.With.Message.Contains("Unsupported"));
        }
        ...
        public void AggressiveLockedCenterIsProjectedVisibleAndUnbound()
        {
            PlayerRouteProfilePayload normalized =
                WeaponMountPolicy.NormalizeRoutePayload(
                    BoundRoute(
                        WeaponMountPolicy
                            .AggressiveLoadoutProfileId,
                        "aggressive"));
            WeaponMountSet mountSet =
                WeaponMountPolicy.BuildMountSet(normalized);
            ...
            Assert.That(
                mountSet.PhysicalBindings.Single(value =>
                    value.MountStableId
                        == WeaponMountPolicy.CenterMountStableId)
        ...
        public void EmptyActiveMountsAreValidAndNotEnabled()
        {
            PlayerRouteProfilePayload empty = PlayerRouteProfilePayload.Create(
                ...
                Id(WeaponMountPolicy.HealerLoadoutProfileId),
                new StableId[PlayerRouteProfilePayload.WeaponSlotCount]);

            WeaponMountSet mountSet =
                WeaponMountPolicy.BuildMountSet(empty);
        ...
        public void LockedAggressiveCenterRejectsBoundPayload()
        {
            PlayerRouteProfilePayload invalid = PlayerRouteProfilePayload.Create(
                ...
                Id(WeaponMountPolicy.AggressiveLoadoutProfileId),
                new[]
                {
            ...
            Assert.That(
                () => WeaponMountPolicy.BuildMountSet(invalid),
        ...
        public void DefensivePositionOrderPreservesOuterAndInnerAssignments()
        {
            PlayerRouteProfilePayload route = BoundRoute(
                ...
                "defensive");
            WeaponMountSet mountSet =
                WeaponMountPolicy.BuildMountSet(route);
        ...
        private static WeaponMountLayout Layout(string profileId)
        {
            return WeaponMountPolicy.ResolveLayout(Id(profileId));
        }

...
{
    public sealed class ExactGunInstanceLoadoutTests
    {
            ...
            string rightKey)
        {
            ...
            Assert.That(
                confirmed.RoutePayload.GunSlots[0]
                    .EquipmentInstanceStableId,
                Is.EqualTo(fixture.InstanceId(leftKey)));
            Assert.That(
                confirmed.RoutePayload.GunSlots[3]
                    .EquipmentInstanceStableId,
                Is.EqualTo(fixture.InstanceId(rightKey)));

            GunMountSet mounts =
                GunMountPolicy.BuildMountSet(
        ...
        public void PlainAndAugmentedRattlersRemainDistinctAndCanSwapPositions()
        {
            ...
            Assert.That(
                second.TryUnequip(
                    InventoryLoadoutSlotIds.GunFour).Status,
                Is.EqualTo(
            ...
            Assert.That(
                ...
                Is.EqualTo(InventoryLoadoutScreenStatus.Confirmed));
            Assert.That(
                swapped.RoutePayload.GunSlots[0]
                    .EquipmentInstanceStableId,
                Is.EqualTo(fixture.AugmentedRattler.InstanceId));
            Assert.That(
                swapped.RoutePayload.GunSlots[3]
                    .EquipmentInstanceStableId,
        ...
        private sealed class Fixture
        {
            ...
            private static EquipmentDefinition Gun(

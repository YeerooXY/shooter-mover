...
namespace ShooterMover.Tests.EditMode.Progression.Skills.Content
{
    public sealed class RankedSkillJsonCatalogV1Tests
    {
        ...
        public void TripleReserveRequiresEightRanksInBothSkills()
        {
            ...
            var sevenEight = new RankedSkillAllocationSnapshotV2(
                ...
                new System.Collections.Generic.Dictionary<string, int>
                {
                    ...
                    ["striker.movement_efficiency"] = 7
                });
            var eightEight = new RankedSkillAllocationSnapshotV2(
                "profile.demo", "class.striker", 2, result.Catalog.SchemaVersion, result.Catalog.ContentVersion,
                new System.Collections.Generic.Dictionary<string, int>
                {
                    ["striker.thruster_recovery"] = 8,
        ...
        {
            string json = ReadProductionDraft().Replace(
        ...
        public void ExcludedRejectedSkillNamesAreAbsent()
        {
            ...
            string[] rejected =
            {
                "Triage", "Medical Reserve", "Lasting Presence", "Overlapping Fire", "Arsenal Rotation",
                "Fortress Protocol", "Brace", "Forward Pressure", "Overrun", "Marked for Elimination"
            };
        ...
        private static RankedSkillAllocationSnapshotV2 Allocation(RankedSkillJsonImportResultV1 result, int credits, int finder, int quality)
        {
            return new RankedSkillAllocationSnapshotV2(
                "profile.demo", "class.striker", credits + finder + quality,
                result.Catalog.SchemaVersion, result.Catalog.ContentVersion,
                new System.Collections.Generic.Dictionary<string, int>
                {
                    ["generic.farming.credit_gain"] = credits,
                    ["generic.farming.strongbox_finder"] = finder,
                    ["generic.farming.strongbox_quality"] = quality
                });
        }
        ...
        {
            string path = Path.Combine(Application.dataPath, RelativeCatalogPath);

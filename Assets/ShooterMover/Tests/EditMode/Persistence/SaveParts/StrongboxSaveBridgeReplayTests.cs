...
namespace ShooterMover.Tests.EditMode.Persistence.SaveParts
{
    public sealed class StrongboxSaveBridgeReplayTests
    {
        ...
        public void AcceptedOpeningAndGeneratedIdentitiesSurviveRestoreWithoutSecondAward()
        {
            ...
            SavePartSnapshot strongboxComponent =
        ...
        public void StrongboxCodecHasDeterministicExplicitGoldenPayload()
        {
            ...
            string first = GameSaveFormats.StrongboxState.Encode(snapshot);
            StrongboxOpeningSnapshot decoded;
            string rejection;
            Assert.That(GameSaveFormats.StrongboxState.TryDecode(
                first,
                out decoded,
                out rejection), Is.True, rejection);
            string second = GameSaveFormats.StrongboxState.Encode(decoded);
            ...
            StrongboxOpeningSnapshot strongboxes)
        {
            return new CharacterInstanceSnapshot(
                ...
                new[]
                {
                    ...
                    new SavePartSnapshot(
                        GameSaveParts.StrongboxState(true)
                            .ComponentStableId,
                        1,
                        GameSaveParts.StrongboxState(true)
                            .ContentVersion,
                        GameSaveFormats.StrongboxState.Encode(strongboxes)),
                });
        }
        ...
        private sealed class AcceptedStrongboxFixture
        {
            ...
            public ISavePart HoldingsAdapter()
            {
            ...
            public ISavePart StrongboxAdapter()
            {

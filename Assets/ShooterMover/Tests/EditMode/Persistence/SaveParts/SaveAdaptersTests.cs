...
namespace ShooterMover.Tests.EditMode.Persistence.SaveParts
{
    public sealed class RealStateSaveAdaptersTests
    {
        ...
        public void PlayerExperienceRealAuthorityRoundTripPreservesReplay()
        {
            ...
            ISavePart sourceAdapter = ExperienceAdapter(source, curve);
            ISavePart targetAdapter = ExperienceAdapter(target, curve);
        ...
        public void ExplicitCodecGoldenPayloadsAreStableAndDoNotUseClrTypes()
        {
            ...
            string xpPayload = GameSaveFormats.PlayerExperience
                .Encode(experience.ExportSnapshot());
            string moneyPayload = GameSaveFormats.MoneyWallet
        ...
        private static ISavePart ExperienceAdapter(
        ...
        private static ISavePart MoneyAdapter(
        ...
        private static ISavePart ScrapAdapter(
        ...
        private static ISavePart HoldingsAdapter(
        ...
        private static ISavePart SkillAdapter(

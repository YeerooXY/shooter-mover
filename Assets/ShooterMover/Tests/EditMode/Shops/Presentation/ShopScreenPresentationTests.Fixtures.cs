...
namespace ShooterMover.Tests.EditMode.Shops.Presentation
{
    ...
    {
        private static ShopScreenPurchaseInput Input(
            string inputId,
            ShopScreenStockCard card)
        {
            return new ShopScreenPurchaseInput(
                Id(inputId),
        ...
        private static ShopDefinition BuildDefinition(int inventorySize)
        {

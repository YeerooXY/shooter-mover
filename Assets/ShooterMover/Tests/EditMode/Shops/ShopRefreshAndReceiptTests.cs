...
namespace ShooterMover.Tests.EditMode.Shops
{
    public sealed class ShopRefreshAndReceiptTests
    {
        ...
        public void SuccessfulPurchaseRemainsSoldAfterReceiptImport()
        {
            ...
            string payload = ShopPurchaseSavePart.Codec.Encode(snapshot);
            ShopReceiptSnapshot decoded;
            string decodeRejection;
            Assert.That(
                ShopPurchaseSavePart.Codec.TryDecode(
                    payload,
                    out decoded,
                    out decodeRejection),
                Is.True,
        ...
        public void OfferAugmentsBecomeDurableOnlyAfterPurchase()
        {
            ...
            Assert.That(
                graph.LoadoutRuntime.GunInventory.Find(
                    entry.Equipment.InstanceId),
                Is.Not.Null,
                "A purchased gun must enter the canonical equippable inventory.");
        }

...
{
    public sealed class PlayerActorStateTests
    {
        [Test]
        public void ValidConstruction_ExportsExactIdentityAtFullHealth()
        {
            PlayerActorState actor = CreateActor(
                Id("actor", "player-a"),
        ...
        public void EquivalentAuthoredData_ProducesIndependentActorInstances()
        {
            ...
            PlayerActorState first = PlayerActorState.TryCreate(definition).Authority;
            PlayerActorState second = PlayerActorState.TryCreate(definition).Authority;
        ...
        {
            PlayerActorState firstTarget = CreateActor(
                Id("actor", "target-a"),
                ...
                50d,
                0L);
            PlayerActorState secondTarget = CreateActor(
                Id("actor", "target-b"),
        ...
        {
            Assembly assembly = typeof(PlayerActorState).Assembly;
            Assert.That(
        ...
        private static PlayerActorState CreateActor()
        {
            return CreateActor(
                Id("actor", "player-a"),
                Id("participant", "local-a"),
        ...
        private static PlayerActorState CreateActor(
            ...
            long generation)
        {
            PlayerActorCreationResult result = PlayerActorState.TryCreate(
        ...
        {
            PlayerActorCreationResult result = PlayerActorState.TryCreate(definition);

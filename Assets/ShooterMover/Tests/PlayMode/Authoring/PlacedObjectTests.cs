...
{
    public sealed class PlacedObjectTests
    {
        ...
        public IEnumerator IdentitySurvivesRenameReparentSiblingAndTransformChanges()
        {
            ...
            GameplayScene firstScope =
                CreateScope("FirstScope", "scope.first");
            GameplayScene secondScope =
        ...
        public IEnumerator DistinctIdsRegisterIndependently()
        {
            ...
            PlacedObject first = CreatePlaced(
                "First",
                scope.transform,
                "placed.crate-a",
                family,
                null);
            PlacedObject second = CreatePlaced(
                "Second",
                scope.transform,
                "placed.crate-b",
                family,
        ...
        {
            ObjectFamilyDefinitionAsset family = CreateFamily();
            GameplayScene compatibleParent =
                CreateScope("CompatibleParent", "scope.parent");
            GameplayScene incompatibleExplicit =
                CreateScope(
        ...
        public IEnumerator MultipleCompatibleScopesAtNearestAncestorFailClosed()
        {
            ...
            GameplayScene first =
                parent.AddComponent<GameplayScene>();

...
namespace ShooterMover.Tests.PlayMode.Combat
{
    ...
    public sealed class PlayerCombatIntentBridgeTests : InputTestFixture
    {
        ...
        public void FireAndPowerPhases_PreservePressHoldReleaseTapAndReleaseThenPress()
        {
            ...
            AddDevice<Mouse>();
            PlayerCombatIntentBridge adapter = CreateCombatAdapter();
        ...
        public void EquivalentKeyboardMouseAndGamepadInputProduceEquivalentCombatIntents()
        {
            ...
            PlayerCombatIntentBridge keyboardAdapter = CreateCombatAdapter();
            ...
            PlayerCombatIntentBridge gamepadAdapter = CreateCombatAdapter();
        ...
        public void ContributingDeviceRemovalClearsHeldStateWithoutPublishingDeviceIdentity()
        {
            ...
            Assert.That(
                PublicSurfaceExposesDeviceIdentifier(typeof(PlayerCombatIntentBridge)),
                Is.False);
            Assert.That(
                typeof(PlayerCombatIntentBridge)
                    .GetMethod(nameof(PlayerCombatIntentBridge.ReadIntentFrame))
                    .ReturnType,
        ...
        public void MovementAndCombatMapsComposeWithoutSessionOwnershipOrConflictingState()
        {
            ...
            Assert.That(DeclaresInputSessionAuthority(typeof(PlayerCombatIntentBridge)), Is.False);
        ...
        public void ReconfigureAndRepeatedEnableProduceOnlyOneConsumablePressAndReleaseEdge()
        {
            ...
            PlayerCombatIntentBridge adapter =
                gameObject.AddComponent<PlayerCombatIntentBridge>();
        ...
        private PlayerCombatIntentBridge CreateCombatAdapter()
        {
            InputActionAsset runtimeAsset = CreateRuntimeAsset(CombatActionAssetPath);
        ...
        private void DestroyAdapter(PlayerCombatIntentBridge adapter)
        {
            if (adapter == null)
            {
                return;

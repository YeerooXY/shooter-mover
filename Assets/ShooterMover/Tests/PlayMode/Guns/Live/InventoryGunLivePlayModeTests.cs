...
namespace ShooterMover.Tests.PlayMode.Guns.Live
{
    public sealed partial class InventoryGunLivePlayModeTests
    {
        ...
        public IEnumerator RouteSlotSelection_ChangesPhysicalEmittedEffects()
        {
            ...
            try
            {
                InventoryGunExecutionResult rattler = fixture.Runtime.TryFire(
                ...
                Assert.That(
                    ...
                    Is.EqualTo(InventoryGunSlotSelectionStatus.Selected));
                InventoryGunExecutionResult ironwake = fixture.Runtime.TryFire(
                ...
                Assert.That(
                    fixture.Emitter.EmittedEffects[1]
                        .Description.Identity.GunDefinitionId.Value,
        ...
        public IEnumerator ActivatedProjectile_TravelsWithItsColliderAwayFromMuzzle()
        {
            ...
            try
            {
                InventoryGunExecutionResult result = fixture.Runtime.TryFire(
                    new FireOperationId(
        ...
        private static Fixture CreateFixture()
        {
            ...
            var runtime = new InventoryGunLiveSetup(
                actor,
                new RouteProfileActiveGunSource(route),
                adapter);

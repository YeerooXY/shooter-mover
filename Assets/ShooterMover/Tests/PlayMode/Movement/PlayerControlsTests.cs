...
namespace ShooterMover.Tests.PlayMode.Movement
{
    ...
    public sealed class PlayerControlsTests : InputTestFixture
    {
        ...
        public void ThrusterPhases_PreservePressHoldReleaseTapAndReleaseThenPress()
        {
            ...
            PlayerControls adapter = CreateAdapter();
        ...
        public void EquivalentKeyboardMouseAndGamepadInputProduceEquivalentIntents()
        {
            ...
            PlayerControls keyboardAdapter = CreateAdapter();
            QueueKeyboardAndMouse(
                keyboard,
                mouse,
                new Vector2(-0.6f, 0.8f),
            ...
            PlayerControls gamepadAdapter = CreateAdapter();
            QueueGamepad(
                gamepad,
        ...
        public void ContributingDeviceDisableClearsHeldStateWithoutPublishingDeviceIdentity()
        {
            ...
            Assert.That(
                PublicSurfaceExposesDeviceIdentifier(typeof(PlayerControls)),
                Is.False);
            Assert.That(
                typeof(PlayerControls)
                    .GetMethod(nameof(PlayerControls.ReadIntentFrame))
                    .ReturnType,
        ...
        private PlayerControls CreateAdapter()
        {
        ...
        private void DestroyAdapter(PlayerControls adapter)
        {
            if (adapter == null)
            {
                return;

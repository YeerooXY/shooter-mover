...
{
    public sealed class MovementBody2DBridgeTests
    {
        ...
        public void BodyAdapter_AppliesBaseAndBurstDomainVelocityDirectly()
        {
            ...
            MovementBody2DBridge adapter = new MovementBody2DBridge(body);
        ...
        {
            FieldInfo bodyField = typeof(MovementBody2DBridge).GetField(
                "body",

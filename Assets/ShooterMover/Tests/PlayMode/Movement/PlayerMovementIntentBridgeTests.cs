...
namespace ShooterMover.Tests.PlayMode.Movement
{
    ...
    public sealed class PlayerMovementIntentBridgeTests : InputTestFixture
    {
        ...
        public void ThrusterPhases_PreservePressHoldReleaseTapAndReleaseThenPress()
        {
            ...
            PlayerMovementIntentBridge adapter = CreateAdapter();
        ...
        public void EquivalentKeyboardMouseAndGamepadInputProduceEquivalentIntents()
        {
            ...
            PlayerMovementIntentBridge keyboardAdapter = CreateAdapter();
            QueueKeyboardAndMouse(
                keyboard,
                mouse,
                new Vector2(-0.6f, 0.8f),
            ...
            PlayerMovementIntentBridge gamepadAdapter = CreateAdapter();
            QueueGamepad(
                gamepad,
        ...
        public void ContributingDeviceDisableClearsHeldStateWithoutPublishingDeviceIdentity()
        {
            ...
            Assert.That(
                PublicSurfaceExposesDeviceIdentifier(typeof(PlayerMovementIntentBridge)),
                Is.False);
            Assert.That(
                typeof(PlayerMovementIntentBridge)
                    .GetMethod(nameof(PlayerMovementIntentBridge.ReadIntentFrame))
                    .ReturnType,
        ...
        private PlayerMovementIntentBridge CreateAdapter()
        {
        ...
        private void DestroyAdapter(PlayerMovementIntentBridge adapter)
        {
            if (adapter == null)
            {
                return;

...
{
    public sealed class MovementContact2DBridgeTests
    {
        ...
        public void WallContact_UsesMT005AndAppliesReflectedOutcomeOnce()
        {
            ...
            Rigidbody2D body;
            MovementContact2DBridge adapter = CreateAdapter(authority, out body);
        ...
        public void AdapterSurface_ContainsOnlyUnity2DPhysicsTypes()
        {
            Type[] inspectedTypes =
            {
                ...
                typeof(MovementContact2DBridge),
        ...
        private MovementContact2DBridge CreateAdapter(
            ...
            out Rigidbody2D body)
        {
            ...
            MovementContact2DBridge adapter = mover.AddComponent<MovementContact2DBridge>();

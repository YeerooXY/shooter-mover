    ...
    public sealed class HubTests
    {
        ...
        private static PlayerRouteProfilePayload CreatePayload()
        {
            return PlayerRouteProfilePayload.Create(
                ...
                new List<StableId>
                {
                    StableId.Parse("equipment-instance.playmode-gun-1"),
                    StableId.Parse("equipment-instance.playmode-gun-2"),
                    StableId.Parse("equipment-instance.playmode-gun-3"),
                    StableId.Parse("equipment-instance.playmode-gun-4"),
                });
        }

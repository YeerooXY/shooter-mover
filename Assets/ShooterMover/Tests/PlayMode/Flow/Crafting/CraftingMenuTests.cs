...
{
    public sealed class CraftingMenuTests
    {
        ...
        public void ControllerCraftsExactPreviewAndReturnsSamePayloadOnce()
        {
            ...
            CraftingMenu controller = CreateController(fixture, out List<PlayerRouteProfilePayload> returns);
        ...
        public void ControllerRetryUsesSameOperationAndDoesNotDoubleSpend()
        {
            ...
            CraftingMenu controller = CreateController(fixture, out _);
            controller.Present(HubRoute.Crafting, fixture.RoutePayload);
        ...
        private CraftingMenu CreateController(
            ControllerFixture fixture,
            out List<PlayerRouteProfilePayload> returns)
        {
            root = new GameObject("CraftingMenuTests");
            CraftingMenu controller =
                root.AddComponent<CraftingMenu>();
        ...
        private sealed class ControllerFixture
        {
            ...
            public static ControllerFixture Create(long balance)
            {
                ...
                EquipmentDefinition gun = EquipmentDefinition.Create(
                    StableId.Parse("gun.playmode"),
                    EquipmentCategoryIds.Gun,
                    StableId.Parse("gun-family.playmode"),
                    "PlayMode Gun",
                    StableId.Parse("gun.runtime-playmode"),

...
{
    public interface IEnemyAttackPatternLineOfSight
    {
        bool HasClearLine(
            Vector2 origin,
            Vector2 target,
    ...
    public sealed class PhysicsEnemyAttackPatternLineOfSight :
        IEnemyAttackPatternLineOfSight
    {
        private readonly int layerMask;

        public PhysicsEnemyAttackPatternLineOfSight(
    ...
    /// </summary>
    public sealed class EnemyAttackPatternController2D
    {
        ...
        private readonly EnemyAttackCapabilityDescriptor attack;
        private readonly EnemyAttackPatternUnitySourceBinding source;
        private readonly EnemyAttackPatternTargetBinding target;
        ...
        private readonly IEnemyAttackPatternLineOfSight lineOfSight;
        private readonly EnemyCommittedAttackPatternExecutor executor;
        private long observedLifecycle;
        private long nextOperationOrdinal;
        private bool lifecycleCancelled;

        public EnemyAttackPatternController2D(
            EnemyDefinition definition,
            EnemyAttackCapabilityDescriptor attack,
            EnemyAttackPatternUnitySourceBinding source,
            ...
            IEnemyAttackPatternLineOfSight lineOfSight,
            EnemyCommittedAttackPatternExecutor executor)
        {
        ...
        public EnemyCommittedAttackPatternResult Tick()
        {
            ...
            EnemyCommittedAttackPatternResult result)
        {
            ...
            if (result.Status != EnemyCommittedAttackPatternStatus.Rejected)
            {
                return false;
            }

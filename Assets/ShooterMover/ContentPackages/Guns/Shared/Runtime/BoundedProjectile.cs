...
{
    public enum BoundedProjectileCompletionReason
    {
        None = 0,
        ConfirmedHit = 1,
    ...
    /// contact through the accepted HitResolver and never applies damage or owns
    /// target state.
    /// </summary>
    [DisallowMultipleComponent]
    [RequireComponent(typeof(Rigidbody2D), typeof(CircleCollider2D))]
    public sealed class BoundedProjectile : MonoBehaviour
    {
        ...
        private HitTranslationResult lastHitTranslation;
        private Collider2D lastCollisionCollider;
        private Vector2 lastCollisionPoint;
        private BoundedProjectileCompletionReason completionReason;

        public event Action<BoundedProjectile> Completed;
        ...
        public BoundedProjectileCompletionReason CompletionReason
        {
            get { return completionReason; }
        }

        public HitTranslationResult LastHitTranslation
        {
            ...
            float configuredPresentationLifetimeSeconds)
        {
            ...
            completionReason = BoundedProjectileCompletionReason.None;
        ...
        public void Cancel()
        {
            ...
            Complete(BoundedProjectileCompletionReason.Cancelled, null);
        }
        ...
        private void Update()
        {
            ...
            {
                Complete(BoundedProjectileCompletionReason.LifetimeExpired, null);
            }
        }
        ...
        private void TryCompleteCollision(Collider2D other, Vector2 contactPoint)
        {
            ...
            HitTranslationResult translation = hitAdapter.TranslateConfirmedHit(
                hitEventId,
                other,
                channel,
                false);
            ...
            Complete(
                confirmed
                    ? BoundedProjectileCompletionReason.ConfirmedHit
                    : BoundedProjectileCompletionReason.CollisionWithoutConfirmedTarget,
                translation);
        }

        private void Complete(
            BoundedProjectileCompletionReason reason,
            HitTranslationResult translation)
        {
            ...
            Action<BoundedProjectile> completed = Completed;
            Completed = null;
            if (completed != null)
            {
                try

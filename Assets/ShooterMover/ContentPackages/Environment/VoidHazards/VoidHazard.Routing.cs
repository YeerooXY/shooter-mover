...
{
    public sealed partial class VoidHazard
    {
        public VoidHazardContactResult HandleContactEnter(VoidTarget target)
        {
        ...
        public bool HandleContactExit(VoidTarget target)
        {
            StableId targetId;

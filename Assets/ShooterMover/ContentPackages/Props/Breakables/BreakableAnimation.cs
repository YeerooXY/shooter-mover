...
{
    [CreateAssetMenu(
        fileName = "BreakableAnimation",
        menuName = "Shooter Mover/Props/Destruction Animation")]
    public sealed class BreakableAnimation : ScriptableObject
    {
        ...
        public static BreakableAnimation CreateRuntime(
            ...
            bool configuredUseUnscaledTime = false)
        {
            ...
            BreakableAnimation animation =
                CreateInstance<BreakableAnimation>();

...
namespace ShooterMover.ContentPackages.Props.DestructibleProps
{
    ...
    /// </summary>
    public sealed class DestructiblePropTerminalProvenance
    {
        public DestructiblePropTerminalProvenance(
        ...
        public DestructiblePropTerminalProvenance WithPlacement(
            StableId roomStableId,
            StableId placementStableId)
        {

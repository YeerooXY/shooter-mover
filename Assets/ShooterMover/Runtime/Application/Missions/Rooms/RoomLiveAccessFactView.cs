...
namespace ShooterMover.Application.Missions.Rooms
{
    ...
    /// </summary>
    public static class RoomLiveAccessFactView
    {
        public static RoomAccessFactSnapshot Build(
            RoomLiveView roomProjection,
            int difficulty,
            ...
            IEnumerable<StableId> consumedHoldings)
        {
            ...
            for (int roomIndex = 0;
                ...
                roomIndex++)
            {
                RoomLiveRoomView room = roomProjection.Rooms[roomIndex];

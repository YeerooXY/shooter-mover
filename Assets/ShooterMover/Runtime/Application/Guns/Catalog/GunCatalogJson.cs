...
{
    public static class GunCatalogJson
    {
        public static string Export(GunCatalog catalog)
        {
            if (catalog == null)
            {
            ...
            writer.BeginObject();
            foreach (KeyValuePair<string, GunArchetypeDefinition> pair in catalog.Archetypes)
            {
        ...
        private static void WriteRules(Writer writer, GunCatalogRules value)
        {
            writer.BeginObject();
        ...
        private static void WriteInputs(Writer writer, GunCatalogInputs value)
        {
            writer.BeginObject();
            ...
            {
                GunRarityInput rarity = value.Rarities[rarityIds[index]];
        ...
        private static void WriteArchetype(Writer writer, GunArchetypeDefinition value)
        {
            writer.BeginObject();
        ...
        private static void WriteFamily(Writer writer, GunFamilyDefinition value)
        {
            writer.BeginObject();
        ...
        private static void WriteDefinition(Writer writer, GunDefinitionData value)
        {
            writer.BeginObject();
        ...
        private static void WriteArtReferences(Writer writer, IReadOnlyList<string> values)
        {
            if (values.Count == 0)
            {
                return;

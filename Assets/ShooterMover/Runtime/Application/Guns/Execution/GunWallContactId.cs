...
namespace ShooterMover.Application.Guns.Execution
{
    ...
    /// </summary>
    public sealed class GunWallContactId :
        IEquatable<GunWallContactId>,
        IComparable<GunWallContactId>
    {
        public GunWallContactId(StableId value)
        {
        ...
        public int CompareTo(GunWallContactId other)
        {
        ...
        public bool Equals(GunWallContactId other)
        {
        ...
        {
            return Equals(obj as GunWallContactId);
        }

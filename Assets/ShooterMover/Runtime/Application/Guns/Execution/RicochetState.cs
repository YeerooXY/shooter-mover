...
namespace ShooterMover.Application.Guns.Execution
{
    ...
    /// </summary>
    public sealed class RicochetState
    {
        private static readonly RicochetState InitialState =
            new RicochetState(
                0,
                null,
                -1L,
                new GunWallContactId[0]);

        private readonly ReadOnlyCollection<GunWallContactId> processedWallContactIds;

        private RicochetState(
            int successfulBounceCount,
            RicochetValue? remainingFixedPointBudget,
            long wallContactSimulationStep,
            IEnumerable<GunWallContactId> processedWallContactIds)
        {
            ...
            List<GunWallContactId> copy = new List<GunWallContactId>();
            foreach (GunWallContactId contactId in processedWallContactIds)
            {
                if (contactId == null)
                {
        ...
        public static RicochetState Initial
        {
        ...
        public IReadOnlyList<GunWallContactId> ProcessedWallContactIds
        {
        ...
        internal RicochetState BeginCanonicalBudget(RicochetValue authoredBudget)
        {
        ...
        internal RicochetState AfterCanonicalWallContact(
            long simulationStep,
            GunWallContactId wallContactId,
        ...
        internal RicochetState AfterWallContact(
            long simulationStep,
            GunWallContactId wallContactId,
        ...
        private RicochetState AfterWallContactCore(
            long simulationStep,
            GunWallContactId wallContactId,
            bool successfulBounce,
            RicochetValue? remainingFixedPointBudget)
        {
            ...
            List<GunWallContactId> nextContacts =
                WallContactSimulationStep == simulationStep
                    ? new List<GunWallContactId>(processedWallContactIds)
                    : new List<GunWallContactId>();

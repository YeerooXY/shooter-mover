...
namespace ShooterMover.Application.Persistence.SaveParts
{
    ...
    /// </summary>
    public static class GunAugmentSavePart
    {
        private static readonly GunAugmentCodec
            CodecValue =
                new GunAugmentCodec();
        ...
        public static GunAugmentCodec Codec
        {
    ...
    public sealed class GunAugmentCodec :
        ExplicitSavePartCodec<
            GeneratedEquipmentAugmentSignatureSnapshot>
    {
        public GunAugmentCodec()

...
namespace ShooterMover.Application.Persistence.SaveParts
{
    ...
    public static class PlayerAccountFileCodec
    {
        ...
        {
            SavePartValidationResult integrity =
    ...
    public sealed class GameSaveFile
    {
        ...
        private readonly Func<PlayerAccountSnapshot,
            SavePartValidationResult> validateAdditionalSemantics;
        ...
        {
            SavePartValidationResult validation = ValidateForUse(
                account,
        ...
        private SavePartValidationResult ValidateForUse(
            PlayerAccountSnapshot account,
            string additionalNullCode)
        {
            SavePartValidationResult mandatory =
                KnownSavePartVersionGuard.Validate(account);
            ...
            SavePartValidationResult additional =
                validateAdditionalSemantics(account);
            return additional
                ?? SavePartValidationResult.Reject(additionalNullCode);
        }

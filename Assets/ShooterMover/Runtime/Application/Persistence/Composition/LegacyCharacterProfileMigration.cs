...
namespace ShooterMover.Application.Persistence.Composition
{
    ...
    public sealed class LegacyCharacterProfileMigrationResult
    {
        public LegacyCharacterProfileMigrationResult(
    ...
    /// </summary>
    public sealed class LegacyCharacterProfileMigration
    {
        ...
        public LegacyCharacterProfileMigration(
        ...
        public LegacyCharacterProfileMigrationResult Migrate(
            IEnumerable<LegacyCharacterProfile> legacyProfiles)
        {
            ...
            if (profiles.Count == 0)
            {
                return new LegacyCharacterProfileMigrationResult(
        ...
        private LegacyCharacterProfileMigrationResult Reject(
            string diagnostic)
        {
            return new LegacyCharacterProfileMigrationResult(
            ...
            out string rejectionCode)
        {
            ...
            {
                ISaveComponentBridge adapter = graph.SaveAdapters[index];
                if (adapter == null

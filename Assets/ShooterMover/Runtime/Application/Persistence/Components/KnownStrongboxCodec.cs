...
{
    public sealed class StrongboxOpeningComponentCodec :
        ExplicitSaveComponentCodec<StrongboxOpeningSnapshot>
    {
        public StrongboxOpeningComponentCodec()
            ...
            StrongboxInstanceContext context)
        {
            return Node.Object(
                ...
                Value.Field("progression_context", PlayerExperienceComponentCodec.EncodeProgressionContext(context.ProgressionContext)),
            ...
            Node node)
        {
            ...
            return StrongboxInstanceContext.Create(
                ...
                PlayerExperienceComponentCodec.DecodeProgressionContext(reader.Next("progression_context")),
            ...
            StrongboxOpeningRecordSnapshot record)
        {
            return Node.Object(
                ...
                Value.Field("consume_command", ExplicitCodecValues.OptionalObject(record.ConsumeCommand, PlayerHoldingsComponentCodec.EncodeHoldingsCommand)),
            ...
            Node node)
        {
            ...
            return new StrongboxOpeningRecordSnapshot(
                ...
                ExplicitCodecValues.OptionalObjectValue(reader.Next("consume_command"), PlayerHoldingsComponentCodec.DecodeHoldingsCommand),
            ...
            RewardGrantApplicationPayload payload)
        {
            return Node.Object(
                ...
                Value.Field("equipment", ExplicitCodecValues.EncodeList(payload.EquipmentInstances, PlayerHoldingsComponentCodec.EncodeEquipment)));
        }
            ...
            Node node)
        {
            ...
            List<EquipmentInstance> equipment = ExplicitCodecValues.DecodeList(
                ...
                PlayerHoldingsComponentCodec.DecodeEquipment);
            switch (grant.Kind)
            {

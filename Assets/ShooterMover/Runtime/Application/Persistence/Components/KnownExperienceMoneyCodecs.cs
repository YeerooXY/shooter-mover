...
{
    public sealed class PlayerExperienceComponentCodec :
        ExplicitSaveComponentCodec<PlayerExperienceSnapshot>
    {
        public PlayerExperienceComponentCodec()
    ...
    public sealed class MoneyWalletComponentCodec :
        ExplicitSaveComponentCodec<MoneyWalletSnapshot>
    {
        public MoneyWalletComponentCodec()

...
namespace ShooterMover.Application.Persistence.Components
{
    ...
    public sealed class ScrapWalletComponentCodec :
        ExplicitSaveComponentCodec<ScrapSnapshot>
    {
        public ScrapWalletComponentCodec()
    ...
    public sealed class RankedSkillAllocationComponentCodec :
        ExplicitSaveComponentCodec<RankedSkillAllocationSnapshot>
    {
        public RankedSkillAllocationComponentCodec()
    ...
    public sealed class ExactInstanceLoadoutComponentCodec :
        ExplicitSaveComponentCodec<InventoryLoadoutStateSnapshot>
    {
        public ExactInstanceLoadoutComponentCodec()

...
namespace ShooterMover.Application.Equipment.Upgrades
{
    public sealed partial class AugmentUpgradeActions
    {
        private bool TryPrepare(
            ...
            out AugmentUpgradeFact failure)
        {
            prepared = null;
            failure = null;
            AugmentUpgradeQuote quote = confirmation.Quote;
            if (quote == null
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.StaleQuote,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.StaleCatalog,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.StaleCostPolicy,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.MissingEquipment,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.MissingAugment,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.CurrentLevelMismatch,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.MaximumLevel,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            AugmentUpgradeCostStatus costStatus = costPolicy.TryCalculateCost(
                ...
                quote.TargetLevel,
                out currentCost);
            if (costStatus == AugmentUpgradeCostStatus.InvalidTarget)
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.InvalidLevelJump,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,
            ...
            StableId replacementId = AugmentUpgrade.DeriveStableId(
                "augitem",
            ...
            {
                failure = Failure(
                    AugmentUpgradeConfirmationStatus.EquipmentValidationRejected,
                    confirmation.ConfirmationStableId,
                    confirmation.Fingerprint,

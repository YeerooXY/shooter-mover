...
{
    public static class WeaponCatalogJson
    {
        ...
        private static void WriteRules(Writer writer, WeaponCatalogRules value)
        {
            writer.BeginObject();
        ...
        private static void WriteArchetype(Writer writer, WeaponArchetypeDefinition value)
        {
            writer.BeginObject();
        ...
        private static void WriteFamily(Writer writer, WeaponFamilyDefinition value)
        {
            writer.BeginObject();
        ...
        private static void WriteDefinition(Writer writer, WeaponDefinitionData value)
        {
            writer.BeginObject();

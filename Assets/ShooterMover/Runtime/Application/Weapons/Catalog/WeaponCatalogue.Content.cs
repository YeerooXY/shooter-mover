...
namespace ShooterMover.Application.Weapons.Catalog
{
    ...
    public static partial class WeaponCatalogue
    {
        ...
        private static readonly WeaponCatalogueView current =
            Build();
        ...
        private static WeaponCatalogueView Build()
        {
            var families = new[]
            {
                BuildFamily(
            ...
            return new WeaponCatalogueView(
                families,
                BuildWeaponCatalog(families),
                BuildEquipmentCatalog(families));
        }

        private static WeaponFamily BuildFamily(
            string slug,
            string displayName,
            string rarity,
        ...
        private static WeaponMark BuildMark(
            string familyId,
            string slug,

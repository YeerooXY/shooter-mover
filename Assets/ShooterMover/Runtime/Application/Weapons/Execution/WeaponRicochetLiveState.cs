...
namespace ShooterMover.Application.Weapons.Execution
{
    ...
    /// </summary>
    public sealed class WeaponRicochetLiveState
    {
        private static readonly WeaponRicochetLiveState InitialState =
            new WeaponRicochetLiveState(
                0,
                null,
                -1L,
        ...
        private WeaponRicochetLiveState(
        ...
        public static WeaponRicochetLiveState Initial
        {
        ...
        internal WeaponRicochetLiveState BeginCanonicalBudget(RicochetValue authoredBudget)
        {
            ...
            return new WeaponRicochetLiveState(
        ...
        internal WeaponRicochetLiveState AfterCanonicalWallContact(
            long simulationStep,
            WeaponWallContactId wallContactId,
        ...
        internal WeaponRicochetLiveState AfterWallContact(
            long simulationStep,
            WeaponWallContactId wallContactId,
        ...
        private WeaponRicochetLiveState AfterWallContactCore(
            long simulationStep,
            WeaponWallContactId wallContactId,
            bool successfulBounce,
            RicochetValue? remainingFixedPointBudget)

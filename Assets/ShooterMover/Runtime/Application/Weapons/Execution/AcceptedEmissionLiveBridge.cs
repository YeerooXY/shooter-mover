...
namespace ShooterMover.Application.Weapons.Execution
{
    ...
    public sealed class AcceptedEmissionLiveBridge
    {
        ...
        public AcceptedEmissionLiveBridge(WeaponBehaviorRegistry registry)
        {
            ...
            int cooldownTicks)
        {
            ...
            if (weapon.ShotPattern.ProjectilesPerShot < 1
                || weapon.ShotPattern.ProjectilesPerShot
                    > WeaponLiveFiringProfile.MaximumEffectsPerFire)
            {
                return Reject(
                    AcceptedEmissionLiveBridgeStatus.UnsupportedShotPattern,
        ...
        private static bool TryBuildProfile(
            EffectiveWeapon weapon,
            int cooldownTicks,
            out WeaponLiveFiringProfile profile,
            ...
            out string code)
        {
            ...
            profile = new WeaponLiveFiringProfile(
                weapon.DefinitionId,
                behaviorId,
                cooldownTicks,
                weapon.ShotPattern.ProjectilesPerShot,
            ...
            WeaponEffectBatch batch)
        {
            if (batch == null
                || batch.Identity == null
                || batch.EffectCount < 1
                || batch.EffectCount > WeaponLiveFiringProfile.MaximumEffectsPerFire

...
namespace ShooterMover.Application.Weapons.Presentation
{
    ...
    /// this layer.
    /// </summary>
    public sealed class WeaponArtReferenceView
    {
        public WeaponArtReferenceView(
    ...
    public static class WeaponArtReferenceResolver
    {
        public static bool TryResolve(
            EquipmentInstance instance,
            EquipmentCatalog equipmentCatalog,
            WeaponCatalog weaponCatalog,
            out WeaponArtReferenceView projection,
            ...
            out string rejectionCode)
        {
            ...
            projection = new WeaponArtReferenceView(

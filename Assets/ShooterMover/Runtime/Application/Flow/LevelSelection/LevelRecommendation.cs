...
{
    public sealed class LevelRecommendation : IEquatable<LevelRecommendation>
    {
        ...
        public bool Equals(LevelRecommendation other)
        {
        ...
        {
            return Equals(obj as LevelRecommendation);
        }

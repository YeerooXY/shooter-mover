...
namespace ShooterMover.Application.Flow.Production
{
    ...
    /// </summary>
    public interface ICharacterStrongboxBridge
    {
        bool TryResolve(
    ...
    public static class CharacterStrongboxBridgeRegistry
    {
        private static ICharacterStrongboxBridge current;
        ...
        public static void Configure(
            ICharacterStrongboxBridge bridge)
        {
            current = bridge
        ...
        public static void Clear(
            ICharacterStrongboxBridge expected = null)
        {

...
namespace ShooterMover.Application.Flow.Production
{
        ...
        ICharacterLiveGraph
    {
        ...
        public CharacterLiveGraph(
            ...
            IEnumerable<ISaveComponentBridge> saveAdapters)
        {
            ...
            SaveAdapters = new ReadOnlyCollection<ISaveComponentBridge>(
                new List<ISaveComponentBridge>(
                    saveAdapters
        ...
        IStarterCharacterLiveGraphFactory
    {
        ...
        private readonly Func<CharacterLiveGraph,
            IEnumerable<ISaveComponentBridge>> additionalAdapterFactory;
        ...
        public CharacterLiveGraphFactory(
            ...
            Func<CharacterLiveGraph,
                IEnumerable<ISaveComponentBridge>>
            ...
            StableId scrapCurrencyId)
        {
            ...
            CharacterStrongboxLive strongboxes =
                CharacterStrongboxSetup.Create(
                    ...
                    money,
                    scrap);
            List<ISaveComponentBridge> adapters =
            ...
            IEnumerable<ISaveComponentBridge> additional =

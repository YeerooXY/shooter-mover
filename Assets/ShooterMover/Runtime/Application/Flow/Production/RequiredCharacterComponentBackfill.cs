...
{
    public sealed class RequiredCharacterComponentBackfillResult
    {
        internal RequiredCharacterComponentBackfillResult(
            bool succeeded,
            bool changed,
    ...
    /// </summary>
    public static class RequiredCharacterComponentBackfill
    {
        public const int MigrationVersion = 1;

        public static RequiredCharacterComponentBackfillResult Migrate(
            PlayerAccountSnapshot account,
            IStarterCharacterLiveGraphFactory starterFactory)
        {
                 ...
                 slotIndex++)
            {
                ...
                try
                {
                    ...
                    var missing = new List<SaveComponentSnapshot>();
                    ...
                    missing.Sort(delegate(
                        SaveComponentSnapshot left,
                        SaveComponentSnapshot right)
                    {
                    ...
                    SaveComponentValidationResult characterValidation =
                        PlayerAccountComponentSemantics.ValidateCharacter(migrated);
            ...
            SaveComponentValidationResult aggregateValidation =
                PlayerAccountComponentSemantics.Validate(next);
            ...
            return new RequiredCharacterComponentBackfillResult(
                true,
        ...
        private static RequiredCharacterComponentBackfillResult Failure(
            string diagnostic,
            PlayerAccountSnapshot account)
        {
            return new RequiredCharacterComponentBackfillResult(

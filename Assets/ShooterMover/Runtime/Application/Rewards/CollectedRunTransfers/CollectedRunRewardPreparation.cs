...
{
    public sealed class CollectedRunRewardGenerationContext
    {
        public CollectedRunRewardGenerationContext(
            ulong rootSeed,
    ...
    public interface ICollectedRunWeaponPayloadSource
    {
    ...
    public static class CollectedRunRewardTransferPreparationFactory
    {
        ...
        public static bool TryCreateAwaitingAcceptedEnd(
            ...
            CollectedRunRewardPreparedTransferStore preparedTransfers,
            CollectedRunRewardGenerationContext generationContext,
            ICollectedRunWeaponPayloadSource equipmentPayloadSource,
            ...
            out string diagnostic)
        {
            ...
            var items = new List<CollectedRunRewardTransferItem>(
                journal.Count);
            var equipment = new List<EquipmentInstance>();
            var boxes = new List<StrongboxInstanceContext>();
            ICollectedRunWeaponPayloadSource equipmentSource =
            ...
            for (int index = 0; index < journal.Count; index++)
            {
                ...
                CollectedRunRewardTransferItem item =
        ...
        public static bool TryAcceptEndAndBuildPlan(
            ...
            out CollectedRunRewardAtomicPlan plan,
            out string diagnostic)
        {
            prepared = null;
            plan = null;
            ...
            string batchFingerprint =
                CollectedRunRewardAtomicPlan.ComputeBatchFingerprint(
            ...
            try
            {
                plan = new CollectedRunRewardAtomicPlan(
                    prepared,
                    commit,
                    claim,
                    payloads,
        ...
        private static CollectedRunRewardTransferItem ToTransferItem(
        ...
        private static ulong DeriveStrongboxSeed(
            CollectedRunRewardGenerationContext context,
            CollectedRunRewardTransferItem item)
        {
            string fingerprint =
                CollectedRunRewardTransfer.Hash(
        ...
        private static string FingerprintItems(
            IReadOnlyList<CollectedRunRewardTransferItem> items)
        {
            var builder = new StringBuilder(
            ...
            return CollectedRunRewardTransfer.Hash(
                builder.ToString());
        }

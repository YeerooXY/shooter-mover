...
{
    internal static class RewardClaimTransfer
    {
    ...
    /// </summary>
    public sealed class RewardClaimTransferItem
    {
        private readonly string canonicalText;

        public RewardClaimTransferItem(
            ...
            string collectedRewardFingerprint)
        {
            ...
            var builder = new StringBuilder(
                "schema=reward-claim-transfer-item-v1");
    ...
    /// </summary>
    public sealed class RewardClaimTransferBatch
    {
        private readonly ReadOnlyCollection<
            RewardClaimTransferItem> rewards;
        private readonly string canonicalText;

        public RewardClaimTransferBatch(
            ...
            IEnumerable<RewardClaimTransferItem> collectedRewards)
        {
            ...
            var copy = new List<RewardClaimTransferItem>(
                collectedRewards
                ?? throw new ArgumentNullException(
            ...
            {
                RewardClaimTransferItem reward = copy[index];
            ...
            rewards =
                new ReadOnlyCollection<
                    RewardClaimTransferItem>(copy);

            var builder = new StringBuilder(
                "schema=reward-claim-transfer-batch-v1");
            RewardClaimTransfer.Append(
                builder,
                "operation",
        ...
        public StableId DeriveChildOperationStableId(
            RewardClaimTransferItem reward,
            string authorityTarget)
        {
            RequireOwnedReward(reward);
            return RewardClaimTransfer
                .DeriveStableId(
                    "operation",
        ...
        private static int CompareRewards(
            RewardClaimTransferItem left,
            RewardClaimTransferItem right)
        {
    ...
    public sealed class RewardClaimTransferReceipt
    {
        ...
        public RewardClaimTransferReceipt(
            ...
            IDictionary<string, string> authorityFingerprints)
        {
            ...
            var builder = new StringBuilder(
                "schema=reward-claim-transfer-receipt-v1");
            RewardClaimTransfer.Append(
                builder,
                "operation",
                OperationStableId);

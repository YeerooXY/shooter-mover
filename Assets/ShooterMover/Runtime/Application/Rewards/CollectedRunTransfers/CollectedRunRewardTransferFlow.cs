...
namespace ShooterMover.Application.Rewards.CollectedRunTransfers
{
    ...
    /// </summary>
    public sealed class CollectedRunRewardTransferFlow
    {
        public const string ApplicationPlanAuthorityKey =
            "collected-run-application-plan-v2";

        private readonly ICollectedRunRewardAtomicBatchStatePort authority;
        private readonly ICollectedRunRewardTransferPersistencePort persistence;

        public CollectedRunRewardTransferFlow(
            ...
            CollectedRunRewardAtomicPlan plan)
        {
            ...
            CollectedRunRewardTransferResult overlap =
            ...
            CollectedRunRewardTransferPersistenceResult custody;
            try
            {
            ...
            {
                CollectedRunRewardTransferPersistenceResult uncertain =
            ...
            try
            {
                CollectedRunRewardAtomicApplyResult applied =
                ...
                authorityFingerprints[ApplicationPlanAuthorityKey] =
                    plan.Fingerprint;
                var receipt = new CollectedRunRewardTransferReceipt(
                    plan.TransferOperationStableId,
                ...
                CollectedRunRewardTransferReceiptRecordResult recorded =
                ...
                CollectedRunRewardTransferPersistenceResult persisted;
                try
                {
                ...
                return new CollectedRunRewardTransferResult(
                    CollectedRunRewardTransferStatus.Applied,
                    plan.TransferOperationStableId,
                    plan.BatchFingerprint,
                    plan.RunStableId,
                    plan.SelectedCharacterStableId,
        ...
        private CollectedRunRewardTransferResult ReplayOrConflict(
            CollectedRunRewardAtomicPlan plan,
            ...
            PermanentRewardTransferState state)
        {
            ...
            return new CollectedRunRewardTransferResult(
                ...
                receipt,
                state,
                new CollectedRunRewardTransferPersistenceResult(
        ...
        private CollectedRunRewardTransferResult
        ...
        private CollectedRunRewardTransferResult RejectAfterCompensation(
            CollectedRunRewardAtomicPlan plan,
            ICollectedRunRewardTransferCompensation compensation,
            string diagnostic,
            CollectedRunRewardTransferPersistenceResult persistenceResult)
        {
            CollectedRunRewardTransferRestoreResult restored;
            try
            {
        ...
        private static CollectedRunRewardTransferResult Reject(
            CollectedRunRewardAtomicPlan plan,
            string diagnostic,
            bool retryAllowed,
            PermanentRewardTransferState state,
            CollectedRunRewardTransferPersistenceResult persistenceResult = null,
            string compensationDiagnostic = "")
        {
            return new CollectedRunRewardTransferResult(
                CollectedRunRewardTransferStatus.Rejected,
                plan.TransferOperationStableId,
                plan.BatchFingerprint,
                plan.RunStableId,
                plan.SelectedCharacterStableId,
        ...
        private static CollectedRunRewardTransferResult Conflict(
            CollectedRunRewardAtomicPlan plan,
            string diagnostic,
            PermanentRewardTransferState state,
            CollectedRunRewardTransferReceipt receipt)
        ...
        private static CollectedRunRewardTransferResult Fatal(
            CollectedRunRewardAtomicPlan plan,
            string diagnostic,
            string compensationDiagnostic,
            CollectedRunRewardTransferPersistenceResult persistenceResult,

...
{
    public enum RewardClaimPreparedTransferState
    {
    ...
    /// </summary>
    public sealed class RewardClaimPreparedTransfer
    {
        private readonly ReadOnlyCollection<RewardClaimTransferItem> rewards;
        ...
        private RewardClaimPreparedTransfer(
            RewardClaimPreparedTransferState state,
            ...
            IEnumerable<RewardClaimTransferItem> rewards,
            IEnumerable<EquipmentInstance> equipment,
            IEnumerable<StrongboxInstanceContext> strongboxes)
        {
            if (!Enum.IsDefined(typeof(RewardClaimPreparedTransferState), state))
            ...
            if (state == RewardClaimPreparedTransferState.Persisted)
                RequireText(
            ...
            var rewardCopy = new List<RewardClaimTransferItem>(
            ...
            {
                RewardClaimTransferItem reward = rewardCopy[index];
            ...
            this.rewards =
                new ReadOnlyCollection<RewardClaimTransferItem>(
                    rewardCopy);
            ...
            var builder = new StringBuilder(
                "schema=reward-claim-prepared-transfer-v1");
            RewardClaimTransfer.Append(builder, "state", (int)State);
            RewardClaimTransfer.Append(builder, "custody", CustodyStableId);
            RewardClaimTransfer.Append(builder, "prepare-operation", PreparationOperationStableId);
            RewardClaimTransfer.Append(builder, "transfer-operation", TransferOperationStableId);
            ...
            RewardClaimTransfer.Append(builder, "end-operation", EndOperationStableId);
            RewardClaimTransfer.Append(builder, "end-command", EndCommandFingerprint);
            RewardClaimTransfer.Append(builder, "mission-result-id", AcceptedMissionResultStableId);
            RewardClaimTransfer.Append(builder, "mission-result", AcceptedMissionResultFingerprint);
            ...
            RewardClaimTransfer.Append(builder, "receipt", PersistedReceiptFingerprint);
            RewardClaimTransfer.Append(builder, "generation-seed", GenerationRootSeed);
            RewardClaimTransfer.Append(builder, "generation-algorithm", GenerationAlgorithmVersion);
            RewardClaimTransfer.Append(builder, "progression", ProgressionContext.Fingerprint);
            RewardClaimTransfer.Append(builder, "event-modifiers", EventModifierFingerprint);
            RewardClaimTransfer.Append(builder, "money-sequence", ExpectedMoneySequence);
            RewardClaimTransfer.Append(builder, "scrap-sequence", ExpectedScrapSequence);
            RewardClaimTransfer.Append(builder, "holdings-sequence", ExpectedHoldingsSequence);
        ...
        public RewardClaimPreparedTransferState State { get; }
        ...
        public IReadOnlyList<RewardClaimTransferItem> Rewards
        {
            get { return rewards; }
        }
        ...
        public static RewardClaimPreparedTransfer AwaitingAcceptedEnd(
            StableId custodyStableId,
            StableId preparationOperationStableId,
            StableId runStableId,
            long lifecycleGeneration,
            ...
            IEnumerable<StrongboxInstanceContext> strongboxes)
        {
            return new RewardClaimPreparedTransfer(
                RewardClaimPreparedTransferState.AwaitingAcceptedEnd,
                custodyStableId,
        ...
        public RewardClaimPreparedTransfer AcceptEnd(
            StableId transferOperationStableId,
            StableId acceptedMissionResultStableId,
            string acceptedMissionResultFingerprint,
            string batchFingerprint,
        ...
        public RewardClaimPreparedTransfer MarkPersisted(
        ...
        private RewardClaimPreparedTransfer Copy(
            RewardClaimPreparedTransferState state,
            StableId transferOperationStableId,
    ...
    public sealed class RewardClaimPreparedTransferSnapshot
    {
        private readonly ReadOnlyCollection<RewardClaimPreparedTransfer> records;
        private readonly Dictionary<StableId, RewardClaimPreparedTransfer> byCustody;
        private readonly Dictionary<StableId, RewardClaimPreparedTransfer> byTransfer;

        public RewardClaimPreparedTransferSnapshot(
            long revision,
            IEnumerable<RewardClaimPreparedTransfer> records)
        {
            if (revision < 0L) throw new ArgumentOutOfRangeException(nameof(revision));
            var copy = new List<RewardClaimPreparedTransfer>(
            ...
            byCustody =
                new Dictionary<StableId, RewardClaimPreparedTransfer>();
            byTransfer =
                new Dictionary<StableId, RewardClaimPreparedTransfer>();
            for (int index = 0; index < copy.Count; index++)
            {
                RewardClaimPreparedTransfer record = copy[index];
            ...
            Revision = revision;
            this.records =
                new ReadOnlyCollection<RewardClaimPreparedTransfer>(
                    copy);
            var builder = new StringBuilder(
                "schema=reward-claim-prepared-transfer-snapshot-v1");
            RewardClaimTransfer.Append(
                builder,
                "revision",
                Revision);
        ...
        public IReadOnlyList<RewardClaimPreparedTransfer> Records
        {
            get { return records; }
        }
        public string Fingerprint { get; }
        public bool TryGetByCustody(
            StableId id,
            out RewardClaimPreparedTransfer value)
        {
            value = null;
        ...
        public static RewardClaimPreparedTransferSnapshot Empty()
        {
            return new RewardClaimPreparedTransferSnapshot(
                0L,
                Array.Empty<RewardClaimPreparedTransfer>());
        }
    }

    public sealed class RewardClaimPreparedTransferStore
    {
        private RewardClaimPreparedTransferSnapshot snapshot;

        public RewardClaimPreparedTransferStore(
            RewardClaimPreparedTransferSnapshot initial = null)
        {
            snapshot = initial
                ?? RewardClaimPreparedTransferSnapshot.Empty();
        }

        public RewardClaimPreparedTransferSnapshot ExportSnapshot()
        {
            return snapshot;
        }
        public bool TryGetByCustody(
        ...
        public IReadOnlyList<RewardClaimPreparedTransfer>
        ...
        public RewardClaimTransferStateStatus Upsert(
            ...
            out string diagnostic)
        {
            ...
            if (incoming == null)
            {
                ...
                return RewardClaimTransferStateStatus.Rejected;
            }
            ...
            if (snapshot.TryGetByCustody(incoming.CustodyStableId, out existing))
            {
                ...
                {
                    return RewardClaimTransferStateStatus.ExactReplay;
                }
                        ...
                        StringComparison.Ordinal))
                {
                    ...
                    return RewardClaimTransferStateStatus
                        .ConflictingDuplicate;
                }
            }
            var next = new List<RewardClaimPreparedTransfer>(
                snapshot.Records);
            if (existing != null) next.Remove(existing);
            next.Add(incoming);
            snapshot = new RewardClaimPreparedTransferSnapshot(
                checked(snapshot.Revision + 1L),
                next);
            return RewardClaimTransferStateStatus.Applied;
        }

        public SavePartApplyResult ImportSnapshot(
            RewardClaimPreparedTransferSnapshot imported)
        {
            if (imported == null)
    ...
    public static class RewardClaimPreparedTransferSavePart
    {
        public const int SchemaVersion = 1;
        public const string ContentVersion =
            "reward-claim-prepared-transfers-explicit-v1";
        public static readonly StableId ComponentStableId =
            StableId.Parse(
                "save-part.reward-claim-prepared-transfers");
            ...
            RewardClaimPreparedTransferStore authority)
        {
            ...
            return new SnapshotSavePart<
                RewardClaimPreparedTransferSnapshot>(
                    Definition(),
                    Codec.Instance,
                ...
                RewardClaimPreparedTransferSnapshot>
        {
            ...
            public bool TryDecode(
                ...
                out RewardClaimPreparedTransferSnapshot snapshot,
            ...
            private static RewardClaimPreparedTransfer ReadRecord(
                BinaryReader reader)
            {
                var state = (RewardClaimPreparedTransferState)
                    reader.ReadInt32();
                ...
                var rewards = new List<RewardClaimTransferItem>(
                    rewardCount);
            ...
            private static RewardClaimTransferItem ReadReward(
                BinaryReader reader)
            {

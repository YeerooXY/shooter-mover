...
{
    public enum CollectedRunRewardPreparedTransferState
    {
    ...
    /// </summary>
    public sealed class CollectedRunRewardPreparedTransfer
    {
        private readonly ReadOnlyCollection<CollectedRunRewardTransferItem> rewards;
        private readonly ReadOnlyCollection<EquipmentInstance> equipment;
        private readonly ReadOnlyCollection<StrongboxInstanceContext> strongboxes;
        private readonly ReadOnlyDictionary<string, string> frozenAuthorityFingerprints;
        private readonly string canonicalText;

        private CollectedRunRewardPreparedTransfer(
            CollectedRunRewardPreparedTransferState state,
            ...
            IEnumerable<CollectedRunRewardTransferItem> rewards,
            IEnumerable<EquipmentInstance> equipment,
            IEnumerable<StrongboxInstanceContext> strongboxes)
        {
            if (!Enum.IsDefined(typeof(CollectedRunRewardPreparedTransferState), state))
            ...
            if (state == CollectedRunRewardPreparedTransferState.Persisted)
                RequireText(
            ...
            var rewardCopy = new List<CollectedRunRewardTransferItem>(
            ...
            {
                CollectedRunRewardTransferItem reward = rewardCopy[index];
            ...
            var strongboxCopy = new List<StrongboxInstanceContext>(
                strongboxes ?? Array.Empty<StrongboxInstanceContext>());
            ...
            {
                CollectedRunRewardTransferItem reward = rewardCopy[index];
                if (reward.RewardKind == RewardGrantKind.EquipmentReference
            ...
            this.rewards =
                new ReadOnlyCollection<CollectedRunRewardTransferItem>(
                    rewardCopy);
            this.equipment = new ReadOnlyCollection<EquipmentInstance>(
                equipmentCopy);
            this.strongboxes =
                new ReadOnlyCollection<StrongboxInstanceContext>(
                    strongboxCopy);
            ...
            CollectedRunRewardTransfer.Append(builder, "state", (int)State);
            CollectedRunRewardTransfer.Append(builder, "custody", CustodyStableId);
            CollectedRunRewardTransfer.Append(builder, "prepare-operation", PreparationOperationStableId);
            CollectedRunRewardTransfer.Append(builder, "transfer-operation", TransferOperationStableId);
            ...
            CollectedRunRewardTransfer.Append(builder, "end-operation", EndOperationStableId);
            CollectedRunRewardTransfer.Append(builder, "end-command", EndCommandFingerprint);
            CollectedRunRewardTransfer.Append(builder, "mission-result-id", AcceptedMissionResultStableId);
            CollectedRunRewardTransfer.Append(builder, "mission-result", AcceptedMissionResultFingerprint);
            ...
            CollectedRunRewardTransfer.Append(builder, "receipt", PersistedReceiptFingerprint);
            CollectedRunRewardTransfer.Append(builder, "generation-seed", GenerationRootSeed);
            CollectedRunRewardTransfer.Append(builder, "generation-algorithm", GenerationAlgorithmVersion);
            CollectedRunRewardTransfer.Append(builder, "progression", ProgressionContext.Fingerprint);
            CollectedRunRewardTransfer.Append(builder, "event-modifiers", EventModifierFingerprint);
            CollectedRunRewardTransfer.Append(builder, "money-sequence", ExpectedMoneySequence);
            CollectedRunRewardTransfer.Append(builder, "scrap-sequence", ExpectedScrapSequence);
            CollectedRunRewardTransfer.Append(builder, "holdings-sequence", ExpectedHoldingsSequence);
        ...
        public CollectedRunRewardPreparedTransferState State { get; }
        ...
        public IReadOnlyList<StrongboxInstanceContext> Strongboxes
        {
        ...
        public static CollectedRunRewardPreparedTransfer AwaitingAcceptedEnd(
            StableId custodyStableId,
            StableId preparationOperationStableId,
            StableId runStableId,
            long lifecycleGeneration,
            ...
            IEnumerable<StrongboxInstanceContext> strongboxes)
        {
            return new CollectedRunRewardPreparedTransfer(
                CollectedRunRewardPreparedTransferState.AwaitingAcceptedEnd,
                custodyStableId,
        ...
        public CollectedRunRewardPreparedTransfer AcceptEnd(
            StableId transferOperationStableId,
            StableId acceptedMissionResultStableId,
            string acceptedMissionResultFingerprint,
            string batchFingerprint,
        ...
        public CollectedRunRewardPreparedTransfer MarkPersisted(
        ...
        private CollectedRunRewardPreparedTransfer Copy(
            CollectedRunRewardPreparedTransferState state,
            StableId transferOperationStableId,
    ...
    public sealed class CollectedRunRewardPreparedTransferSnapshot
    {
        private readonly ReadOnlyCollection<CollectedRunRewardPreparedTransfer> records;
        private readonly Dictionary<StableId, CollectedRunRewardPreparedTransfer> byCustody;
        private readonly Dictionary<StableId, CollectedRunRewardPreparedTransfer> byTransfer;

        public CollectedRunRewardPreparedTransferSnapshot(
            long revision,
            IEnumerable<CollectedRunRewardPreparedTransfer> records)
        {
            if (revision < 0L) throw new ArgumentOutOfRangeException(nameof(revision));
            var copy = new List<CollectedRunRewardPreparedTransfer>(
            ...
            byCustody =
                new Dictionary<StableId, CollectedRunRewardPreparedTransfer>();
            byTransfer =
                new Dictionary<StableId, CollectedRunRewardPreparedTransfer>();
            for (int index = 0; index < copy.Count; index++)
            {
                CollectedRunRewardPreparedTransfer record = copy[index];
            ...
            Revision = revision;
            this.records =
                new ReadOnlyCollection<CollectedRunRewardPreparedTransfer>(
                    copy);
            var builder = new StringBuilder(
        ...
        public IReadOnlyList<CollectedRunRewardPreparedTransfer> Records
        {
            get { return records; }
        }
        public string Fingerprint { get; }
        public bool TryGetByCustody(
            StableId id,
            out CollectedRunRewardPreparedTransfer value)
        {
            value = null;
        ...
        public static CollectedRunRewardPreparedTransferSnapshot Empty()
        {
            return new CollectedRunRewardPreparedTransferSnapshot(
                0L,
                Array.Empty<CollectedRunRewardPreparedTransfer>());
        }
    }

    public sealed class CollectedRunRewardPreparedTransferStore
    {
        private CollectedRunRewardPreparedTransferSnapshot snapshot;

        public CollectedRunRewardPreparedTransferStore(
            CollectedRunRewardPreparedTransferSnapshot initial = null)
        {
            snapshot = initial
                ?? CollectedRunRewardPreparedTransferSnapshot.Empty();
        }

        public CollectedRunRewardPreparedTransferSnapshot ExportSnapshot()
        {
            return snapshot;
        }
        public bool TryGetByCustody(
        ...
        public IReadOnlyList<CollectedRunRewardPreparedTransfer>
        ...
        public CollectedRunRewardTransferStateStatus Upsert(
            ...
            out string diagnostic)
        {
            ...
            if (incoming == null)
            {
                ...
                return CollectedRunRewardTransferStateStatus.Rejected;
            }
            ...
            if (snapshot.TryGetByCustody(incoming.CustodyStableId, out existing))
            {
                ...
                {
                    return CollectedRunRewardTransferStateStatus.ExactReplay;
                }
                        ...
                        StringComparison.Ordinal))
                {
                    ...
                    return CollectedRunRewardTransferStateStatus
                        .ConflictingDuplicate;
                }
            }
            var next = new List<CollectedRunRewardPreparedTransfer>(
                snapshot.Records);
            if (existing != null) next.Remove(existing);
            next.Add(incoming);
            snapshot = new CollectedRunRewardPreparedTransferSnapshot(
                checked(snapshot.Revision + 1L),
                next);
            return CollectedRunRewardTransferStateStatus.Applied;
        }

        public SaveComponentApplyResult ImportSnapshot(
            CollectedRunRewardPreparedTransferSnapshot imported)
        {
            if (imported == null)
    ...
    public static class CollectedRunRewardPreparedTransferSaveComponent
    {
            ...
            CollectedRunRewardPreparedTransferStore authority)
        {
            ...
            return new StateSnapshotSaveComponentBridge<
                CollectedRunRewardPreparedTransferSnapshot>(
                    Definition(),
                    Codec.Instance,
                ...
                CollectedRunRewardPreparedTransferSnapshot>
        {
            ...
            public bool TryDecode(
                ...
                out CollectedRunRewardPreparedTransferSnapshot snapshot,
            ...
            private static CollectedRunRewardPreparedTransfer ReadRecord(
                BinaryReader reader)
            {
                var state = (CollectedRunRewardPreparedTransferState)
                    reader.ReadInt32();
                ...
                var rewards = new List<CollectedRunRewardTransferItem>(
                    rewardCount);
                ...
                var strongboxes =
                    new List<StrongboxInstanceContext>(strongboxCount);
            ...
            private static void WriteReward(
                BinaryWriter writer,
                CollectedRunRewardTransferItem value)
            {
            ...
            private static CollectedRunRewardTransferItem ReadReward(
                BinaryReader reader)
            {
                return new CollectedRunRewardTransferItem(
                    ReadId(reader),
                    (RewardGrantKind)reader.ReadInt32(),
                    ReadId(reader),
                    reader.ReadInt64(),
                    ReadId(reader),
                    ReadId(reader),
            ...
            private static void WriteStrongbox(
                BinaryWriter writer,
                StrongboxInstanceContext value)
            {
            ...
            private static StrongboxInstanceContext ReadStrongbox(
                BinaryReader reader)
            {
            ...
            private static int ReadCount(BinaryReader reader)
            {
                ...
                if (value < 0
                    || value > SavePersistenceLimits.MaximumCollectionCount)
                {

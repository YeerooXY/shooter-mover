...
namespace ShooterMover.Application.Rewards.CollectedRunTransfers
{
    ...
    /// </summary>
    public static class CollectedRunRewardLiveRegistry
    {
        private sealed class Entry
        {
            public RewardApplicationActions RewardApplication;
            public CollectedRunRewardPreparedTransferStore Prepared;
            public CollectedRunRewardTransferReceiptState Receipts;
            public CharacterLiveGraph Graph;
        ...
        public static IReadOnlyList<ISaveComponentBridge> CreateSaveAdapters(
            StableId characterStableId)
        {
            if (characterStableId == null)
                throw new ArgumentNullException(nameof(characterStableId));
            lock (Gate)
            {
                ...
                entry.Receipts =
                    new CollectedRunRewardTransferReceiptState();
                return new ISaveComponentBridge[]
                {
        ...
        public static bool TryResolve(
            ...
            out CollectedRunRewardPreparedTransferStore prepared,
            out CollectedRunRewardTransferReceiptState receipts)
        {
            CharacterLiveGraph ignoredGraph;
            CharacterSetupFlow ignoredComposition;
        ...
        public static bool TryResolveRuntime(
            ...
            out CharacterSetupFlow composition,
            out RewardApplicationActions rewardApplication,
            out CollectedRunRewardPreparedTransferStore prepared,
            out CollectedRunRewardTransferReceiptState receipts,

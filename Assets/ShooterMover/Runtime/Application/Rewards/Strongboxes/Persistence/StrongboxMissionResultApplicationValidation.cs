...
namespace ShooterMover.Application.Rewards.Strongboxes.Persistence
{
    public sealed partial class StrongboxMissionResultApplicationFlow
    {
            ...
            out string rejection)
        {
            ...
            IStrongboxMissionResultApplicationStatePort target =
            ...
            Dictionary<StableId, UniqueHoldingSnapshot> sourceHeld =
                command.SourceHoldings.UniqueHoldings
                    ...
                    .ToDictionary(
                        ...
                        item => item);
            Dictionary<StableId, StrongboxInstanceContext> sourceContexts =
            ...
            for (int index = 0;
                ...
                index++)
            {
                MissionRunStrongboxResult resultBox =

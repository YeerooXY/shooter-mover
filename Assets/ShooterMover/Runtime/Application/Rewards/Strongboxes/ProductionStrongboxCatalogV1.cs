    ...
    public static class ProductionStrongboxCatalogV1
    {
        private static readonly ReadOnlyCollection<ProductionStrongboxTierV1> TiersValue =
            new ReadOnlyCollection<ProductionStrongboxTierV1>(
                ...
                {
                    Tier(1, "steel", "Steel", -6, 5200, 1, 2, 700, 5, 10, 82, 17, 1, 80, 800, 0),
                    Tier(2, "copper", "Copper", -4, 5000, 1, 2, 650, 8, 16, 78, 20, 2, 90, 900, 5),
                    Tier(3, "silver", "Silver", -2, 4700, 1, 2, 600, 12, 24, 72, 25, 3, 100, 1000, 10),
                    Tier(4, "amethyst", "Amethyst", 0, 4400, 1, 3, 550, 18, 36, 64, 31, 5, 115, 1150, 20),
                    Tier(5, "gold", "Gold", 2, 4100, 1, 3, 500, 25, 50, 55, 37, 8, 130, 1300, 35),
                    Tier(6, "black-opal", "Black Opal", 4, 3800, 1, 3, 475, 35, 70, 46, 42, 12, 150, 1500, 55),
                    Tier(7, "blue-sapphire", "Blue Sapphire", 6, 3500, 1, 3, 450, 50, 100, 37, 46, 17, 175, 1750, 80),
                    Tier(8, "emerald", "Emerald", 8, 3200, 2, 3, 425, 70, 140, 29, 49, 22, 205, 2050, 115),
                    Tier(9, "alexandrite", "Alexandrite", 10, 2900, 2, 3, 400, 100, 200, 21, 50, 29, 240, 2400, 160),
                    Tier(10, "red-diamond", "Red Diamond", 12, 2600, 2, 3, 350, 150, 300, 14, 48, 38, 285, 2850, 225),
                    Tier(11, "antimatter", "Antimatter", 14, 2200, 3, 3, 300, 250, 500, 7, 40, 53, 350, 3500, 320),
                });

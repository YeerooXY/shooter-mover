...
namespace ShooterMover.Application.Rewards.Strongboxes
{
    ...
    /// </summary>
    public sealed class StrongboxTier
    {
        public StrongboxTier(
            int tierNumber,
            string slug,
            string displayName,
            int levelOffset,
        ...
        public StrongboxPowerBudgetPolicy CreatePowerBudgetPolicy()
        {
        ...
        public StrongboxDefinition CreateDefinition(StableId generationPolicyStableId)
        {
    ...
    public static class StrongboxCatalog
    {
        private static readonly ReadOnlyCollection<StrongboxTier> TiersValue =
            new ReadOnlyCollection<StrongboxTier>(
                new List<StrongboxTier>
                {
        ...
        public static IReadOnlyList<StrongboxTier> Tiers
        {
            get { return TiersValue; }
        }

        public static StrongboxTier GetByNumber(int tierNumber)
        {
        ...
        public static bool TryGet(StableId tierStableId, out StrongboxTier tier)
        {
        ...
        private static StrongboxTier Tier(
            int number,
            string slug,
            string name,
            int levelOffset,

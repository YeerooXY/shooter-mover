...
namespace ShooterMover.Application.Rewards.Generation
{
    public sealed partial class RewardGenerationActions
    {
        ...
        {
            private readonly List<RewardGenerationTraceEntry> entries = new List<RewardGenerationTraceEntry>();
            ...
            public void Add(
                ...
                string detail)
            {
                entries.Add(new RewardGenerationTraceEntry(
                    entries.Count,
                    stepId,
                    subjectId,
                    decision,
            ...
            public RewardGenerationTrace Build(

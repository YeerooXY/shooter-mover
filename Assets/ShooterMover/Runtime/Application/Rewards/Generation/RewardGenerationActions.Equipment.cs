...
namespace ShooterMover.Application.Rewards.Generation
{
    ...
    {
        public EquipmentGenerationResult GenerateEquipment(EquipmentGenerationRequest request)
        {
            if (request == null)
            {
            ...
            {
                EquipmentGenerationCandidate candidate = request.Policy.EquipmentCandidates[index];
                ...
                trace.Add(
                    ...
                    RewardGenerationTraceDecision.Eligibility,
                    null,
                    0UL,
                    0UL,
                    eligible ? 1L : 0L,
            ...
            if (eligibleEquipment.Count == 0)
            {
                return BuildEquipmentFailure(
                    ...
                    RewardGenerationStatus.NoEligibleCandidate);
            }
            ...
            if (!TrySelectWeighted(
                ...
                RewardGenerationFingerprint.StableOrdinal(request.OperationId),
                eligibleEquipment,
            ...
            DeterministicRandom levelStream = root.Fork(
                ...
                RewardGenerationFingerprint.StableOrdinal(definition.DefinitionId));
            ...
            {
                EquipmentQualityCandidate candidate = request.Policy.QualityCandidates[index];
            ...
            ulong qualitySample;
            ulong qualityOrdinal = RewardGenerationFingerprint.StableOrdinal(definition.DefinitionId);
            if (!TrySelectWeighted(
                root,
            ...
            trace.Add(
                ...
                RewardGenerationTraceDecision.Quality,
                PurposeEquipmentQuality,
                qualityOrdinal,
            ...
            int requestedSlots;
            ulong slotsOrdinal = RewardGenerationFingerprint.StableOrdinal(request.EquipmentInstanceId);
            ...
            trace.Add(
                ...
                RewardGenerationTraceDecision.SlotCount,
            ...
            for (int slotIndex = 0; slotIndex < requestedSlots; slotIndex++)
            {
                ...
                StableId slotSubject = RewardGenerationFingerprint.DeriveStableId(
                    "generation-slot",
                    request.OperationId.ToString(),
                    slotIndex.ToString(CultureInfo.InvariantCulture));
                ulong augmentOrdinal = RewardGenerationFingerprint.StableOrdinal(slotSubject);
                ...
                trace.Add(
                    ...
                    RewardGenerationTraceDecision.AugmentSelection,
                    PurposeAugmentSelection,
                    augmentOrdinal,
                ...
                StableId augmentInstanceId = RewardGenerationFingerprint.DeriveStableId(
                    "augment-instance",
                    request.OperationId.ToString(),
                    slotIndex.ToString(CultureInfo.InvariantCulture));
                int augmentTier;
                DeterministicRandom tierStream = root.Fork(
                    PurposeAugmentTier,
                    RewardGenerationFingerprint.StableOrdinal(augmentInstanceId));
                ...
                trace.Add(
                    StepAugment,
                    selectedAugment.Definition.DefinitionId,
                    RewardGenerationTraceDecision.AugmentTier,
                    PurposeAugmentTier,
                    RewardGenerationFingerprint.StableOrdinal(augmentInstanceId),
                ...
                trace.Add(
                    StepAugment,
                    selectedAugment.Definition.DefinitionId,
                    RewardGenerationTraceDecision.AugmentLevel,
                    PurposeAugmentLevel,
                    RewardGenerationFingerprint.StableOrdinal(augmentInstanceId),
            ...
            trace.Add(
                ...
                RewardGenerationTraceDecision.Validation,
                null,
                0UL,
                0UL,
                1L,
            ...
            RewardGenerationTrace finalTrace = trace.Build(
                request.AlgorithmVersion,
                request.RootSeed,
                contentFingerprint,
                request.Context.Fingerprint,
                resultFingerprint);
            return new EquipmentGenerationResult(

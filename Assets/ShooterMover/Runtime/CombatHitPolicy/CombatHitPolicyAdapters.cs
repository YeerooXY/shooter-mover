...
namespace ShooterMover.Combat.HitPolicy
{
    ...
    /// </summary>
    public static class CombatHitDamageCommandBridge
    {
            ...
            out DamageReceiverCommand command)
        {
            ...
            if (policyResult == null
                ...
                || policyResult.Input.Contact.Kind != CombatHitContactKind.Actor
    ...
    /// </summary>
    public static class CombatHitPropDamageCommandBridge
    {
        public static bool TryCreate(
            CombatHitPolicyResult policyResult,

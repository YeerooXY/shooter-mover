...
{
    internal static class EnemyAttackPatternFingerprint
    {
        public static string Execution(EnemyAttackExecutionRequest execution)
        {
        ...
        public static string Sequence(EnemyAttackSequence sequence)
        {
            var builder = new StringBuilder("enemy-attack-sequence-v1");
            EnemyAttackSequenceIdentity identity = sequence.Identity;
        ...
        public static string CancellationCommand(EnemyAttackLifecycleCancellationCommand command)
        {
        ...
        public static string Cancellation(EnemyAttackSequenceCancellationFact fact)
        {
            ...
            EnemyAttackCapabilityDescriptor descriptor)
        {
            ...
            EnemyProjectilePayload payload = descriptor.ProjectilePayload;
            if (payload == null)
            {

...
{
    internal static class EnemyLiveStateFingerprint
    {
        public static string Decision(EnemyPlacementDecision decision)
        {
        ...
        public static string AimContext(EnemyTargetingAimContext context)
        {
        ...
        public static string AttackAttempt(
            ...
            EnemyDifficultyContext difficultyContext,
        ...
        public static string Descriptor(EnemyAttackCapabilityDescriptor descriptor)
        {
        ...
        public static bool IdentityEquals(
            EnemyLiveIdentity left,
            EnemyLiveIdentity right)
        {
        ...
        private static void AppendBinding(StringBuilder builder, EnemyLiveAttackBinding binding)
        {
            if (binding == null)
            {
            ...
            EnemyTargetingAimPolicyConfiguration aim = binding.TargetingAim.Configuration;
            ...
            EnemyAttackCapabilityConfiguration capability = binding.Capability.Configuration;
            ...
            EnemyAttackCapabilityDescriptor descriptor)
        {
            ...
            EnemyProjectileAttackParameters projectile = descriptor.Projectile;
            if (projectile == null)
            {
            ...
            EnemyAreaAttackParameters area = descriptor.Area;
            if (area == null)
            {
            ...
            EnemyMeleeAttackParameters melee = descriptor.Melee;
            if (melee == null)
            {
        ...
        private static void AppendIdentity(StringBuilder builder, EnemyLiveIdentity identity)
        {
            if (identity == null)
            {
        ...
        private static void AppendScaling(StringBuilder builder, EnemyDifficultyScaling scaling)
        {
            if (scaling == null)
            {

...
{
    public enum EnemyPlacementLiveFactoryRejection
    {
        None = 0,
    ...
    public sealed class EnemyPlacementLiveFactoryResult
    {
        private EnemyPlacementLiveFactoryResult(
            EnemyPlacementLiveInstance runtime,
            EnemyPlacementLiveFactoryRejection rejection,
            string diagnostic)
        {
            Runtime = runtime;
            Rejection = rejection;
        ...
        public EnemyPlacementLiveFactoryRejection Rejection { get; }
        ...
        public bool IsCreated
        {
            ...
            {
                return Runtime != null
                    && Rejection == EnemyPlacementLiveFactoryRejection.None;
            }
        }

        internal static EnemyPlacementLiveFactoryResult Created(
            EnemyPlacementLiveInstance runtime)
        {
            return new EnemyPlacementLiveFactoryResult(
                runtime ?? throw new ArgumentNullException(nameof(runtime)),
                EnemyPlacementLiveFactoryRejection.None,
                string.Empty);
        }

        internal static EnemyPlacementLiveFactoryResult Rejected(
            EnemyPlacementLiveFactoryRejection rejection,
            string diagnostic)
        {
            if (rejection == EnemyPlacementLiveFactoryRejection.None)
                throw new ArgumentOutOfRangeException(nameof(rejection));
            return new EnemyPlacementLiveFactoryResult(null, rejection, diagnostic);
        }
    }

    public sealed class EnemyRoomPlacementSetupResult
    {
        private readonly ReadOnlyCollection<EnemyPlacementLiveInstance> runtimes;
        private readonly ReadOnlyCollection<RoomOccupantRegistration> occupants;

        private EnemyRoomPlacementSetupResult(
            StableId roomStableId,
            IEnumerable<EnemyPlacementLiveInstance> runtimes,
            IEnumerable<RoomOccupantRegistration> occupants,
            EnemyPlacementLiveFactoryRejection rejection,
            string diagnostic)
        {
            RoomStableId = roomStableId;
            this.runtimes = new ReadOnlyCollection<EnemyPlacementLiveInstance>(
                new List<EnemyPlacementLiveInstance>(
                    runtimes ?? Array.Empty<EnemyPlacementLiveInstance>()));
        ...
        public IReadOnlyList<EnemyPlacementLiveInstance> Runtimes { get { return runtimes; } }
        public IReadOnlyList<RoomOccupantRegistration> Occupants { get { return occupants; } }
        public EnemyPlacementLiveFactoryRejection Rejection { get; }
        public string Diagnostic { get; }
        public bool IsCreated { get { return Rejection == EnemyPlacementLiveFactoryRejection.None; } }
            ...
            string diagnostic)
        {
            return new EnemyRoomPlacementSetupResult(
                null,
                Array.Empty<EnemyPlacementLiveInstance>(),
    ...
    public sealed class EnemyPlacementLiveFactory
    {
        ...
        private readonly EnemyLivePolicyRegistry policies;
        ...
        public EnemyPlacementLiveFactory(
            IRoomContentObjectCatalog roomObjects,
            EnemyCatalog enemies,
            EnemyLivePolicyRegistry policies,
        ...
        public EnemyPlacementLiveFactoryResult Create(EnemyPlacementLiveRequest request)
        {
            ...
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.RoomObjectNotFound,
                    request.Placement.ObjectStableId);
            }
            ...
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.EnemyDefinitionNotFound,
                    roomObject.RuntimeDefinitionStableId);
            }
            if (roomObject.PresentationStableId != definition.PresentationId)
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.PresentationMismatch,
            ...
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.LevelOutOfRange,
                    definition.DefinitionId);
            }
            ...
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.MovementPolicyNotRegistered,
            ...
            {
                return Reject(
                    EnemyPlacementLiveFactoryRejection.DecisionPolicyNotRegistered,
            ...
            for (int index = 0; index < definition.Attacks.Count; index++)
            {
                ...
                {
                    return Reject(
                        EnemyPlacementLiveFactoryRejection.AttackCapabilityNotRegistered,
                ...
                {
                    return Reject(
                        EnemyPlacementLiveFactoryRejection.TargetingAimPolicyNotRegistered,
                        capability.Configuration.TargetingAimPolicyId);
                }
            ...
            return EnemyPlacementLiveFactoryResult.Created(
                new EnemyPlacementLiveInstance(
                    request,
                    identity,
                    roomObject,
                    definition,
            ...
            IEnumerable<EnemyPlacementLiveRequest> requests)
        {
            ...
            var runtimes = new List<EnemyPlacementLiveInstance>();
            ...
            foreach (EnemyPlacementLiveRequest request in requests)
            {
                ...
                else if (roomStableId != request.Placement.RoomStableId)
                {
                    return EnemyRoomPlacementSetupResult.Rejected(
                        EnemyPlacementLiveFactoryRejection.MixedRoomBatch,
                ...
                {
                    return EnemyRoomPlacementSetupResult.Rejected(
                        EnemyPlacementLiveFactoryRejection.MixedRuntimeBatch,
                        "enemy-factory:mixed-runtime-batch");
                }

                EnemyPlacementLiveFactoryResult result = Create(request);
                if (!result.IsCreated)
                {
                    return EnemyRoomPlacementSetupResult.Rejected(
                        result.Rejection,
                ...
                {
                    return EnemyRoomPlacementSetupResult.Rejected(
                        EnemyPlacementLiveFactoryRejection.DuplicateSpawnIdentity,
        ...
        private static EnemyPlacementLiveFactoryResult Reject(
            EnemyPlacementLiveFactoryRejection rejection,
            StableId id)
        {
            return EnemyPlacementLiveFactoryResult.Rejected(
                rejection,

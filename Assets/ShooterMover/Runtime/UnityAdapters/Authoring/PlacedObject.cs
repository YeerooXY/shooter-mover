...
namespace ShooterMover.UnityAdapters.Authoring
{
    ...
    public sealed class PlacedObject : MonoBehaviour
    {
        ...
        [Header("Scope")]
        [SerializeField] private GameplayScene explicitScope;
        ...
        private GameplayScene _boundScope;
        ...
        public GameplayScene BoundScope
        {
        ...
        private bool TryResolveScope(
            ...
            out GameplayScene resolvedScope,
            out SceneScopeBindingResult failure)
        {
            ...
            while (ancestor != null)
            {
                GameplayScene[] candidates =
                    ancestor.GetComponents<GameplayScene>();
                GameplayScene compatible = null;
                int compatibleCount = 0;

                for (int index = 0; index < candidates.Length; index++)
                {
                    GameplayScene candidate = candidates[index];
                    if (candidate != null

...
namespace ShooterMover.UnityAdapters.Physics
{
        ...
        IDisposable
    {
        ...
        private readonly PlayerControls inputAdapter;
        private readonly MovementContact contactAdapter;
        private readonly MovementBody bodyAdapter;
        ...
        private void ThrowIfDisposed()
        {
            if (isDisposed)
            {
                throw new ObjectDisposedException(nameof(Mover));
            }
        }

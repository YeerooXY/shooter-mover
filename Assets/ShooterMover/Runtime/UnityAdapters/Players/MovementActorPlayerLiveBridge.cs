...
namespace ShooterMover.UnityAdapters.Players
{
    ...
    public sealed class MovementActorPlayerLiveBridge : IPlayerMovementLive
    {
        ...
        {
            if (IsDisposed) throw new ObjectDisposedException(nameof(MovementActorPlayerLiveBridge));
        }
    }
}

...
{
    public sealed class WeaponArtSpriteResolution
    {
        public WeaponArtSpriteResolution(
    ...
    /// </summary>
    public static class WeaponArtSpriteRegistry
    {
        ...
        private static readonly Dictionary<string, WeaponArtSpriteResolution>
            Cache = new Dictionary<string, WeaponArtSpriteResolution>(
        ...
        public static WeaponArtSpriteResolution Preload(
            string artReferenceId)
        {
            string canonical = string.IsNullOrWhiteSpace(artReferenceId)
                ? string.Empty
                : artReferenceId.Trim();
            WeaponArtSpriteResolution cached;
            ...
            var resolution = new WeaponArtSpriteResolution(
                canonical,
                sprite,
                fallback,
                diagnostic);

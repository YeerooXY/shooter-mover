...
namespace ShooterMover.UnityAdapters.CombatPresentation
{
    ...
    public interface IDeathEffectsFactory : IDisposable
    {
        string SourcePresentationId { get; }
        IDeathEffects Create(Transform parent, int ordinal);
    }
    ...
    public sealed class DeathEffects : MonoBehaviour
    {
        ...
        private readonly List<IDeathEffects> instances =
            new List<IDeathEffects>();
        private IDeathEffectsFactory factory;
        ...
        public int ActiveCount
        {
            get
            {
                ...
                {
                    IDeathEffects instance = instances[index];
        ...
        public void Configure(
            IDeathEffectsFactory configuredFactory,
        ...
        public IDeathEffects Spawn(Vector3 position, float scale)
        {
            ...
            IDeathEffects instance = Acquire();
            spawnSequence++;
        ...
        private IDeathEffects Acquire()
        {
            for (int index = 0; index < instances.Count; index++)
            {
                IDeathEffects existing = instances[index];
                if (existing != null
                    && existing.Root != null
                    && !existing.IsActive)
                {
            ...
            {
                IDeathEffects created = factory.Create(
                    transform,
                    instances.Count);
            ...
            IDeathEffects recycled = instances[recycleCursor];
    ...
    /// </summary>
    public sealed class SpriteDeathEffectsFactory : IDeathEffectsFactory
    {
        private readonly SpriteAnimationCombatDeathVfxDefinition definition;
        private readonly IDeathEffectsFactory fallback;

        public SpriteDeathEffectsFactory(
            SpriteAnimationCombatDeathVfxDefinition definition,
            IDeathEffectsFactory fallback)
        {
        ...
        public IDeathEffects Create(Transform parent, int ordinal)
        {
            ...
            root.AddComponent<GeneratedCombatVisual>();
            SpriteRenderer renderer = root.AddComponent<SpriteRenderer>();
            SpriteDeathEffects instance =
                root.AddComponent<SpriteDeathEffects>();
    ...
    [DisallowMultipleComponent]
    public sealed class SpriteDeathEffects :
        MonoBehaviour,
        IDeathEffects
    {
    ...
    public sealed class RingDeathEffectsFactory : IDeathEffectsFactory
    {
        ...
        public RingDeathEffectsFactory(
        ...
        public IDeathEffects Create(Transform parent, int ordinal)
        {
            ...
            RingDeathEffects instance =
                root.AddComponent<RingDeathEffects>();
    ...
    [DisallowMultipleComponent]
    public sealed class RingDeathEffects :
        MonoBehaviour,
        IDeathEffects
    {

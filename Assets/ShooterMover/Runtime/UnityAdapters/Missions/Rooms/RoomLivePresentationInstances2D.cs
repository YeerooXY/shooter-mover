...
namespace ShooterMover.UnityAdapters.Missions.Rooms
{
    ...
    public sealed class RoomPlacedInstance2D : MonoBehaviour
    {
        ...
        public void Configure(
            RoomLiveSetup2D configuredOwner,
    ...
    /// either directly to an IEnemyActor2DState component or to a component exposing
    ...
    {
        private IEnemyActor2DState authority;
        ...
        public bool TryBind()
        {
            ...
            for (int index = 0; index < components.Length; index++)
            {
                ...
                IEnemyActor2DState direct = component as IEnemyActor2DState;
                if (direct != null)
                {
                ...
                IEnemyActor2DState nested =
                    property.GetValue(component, null) as IEnemyActor2DState;
        ...
        private void Bind(Component owner, IEnemyActor2DState boundAuthority)
        {

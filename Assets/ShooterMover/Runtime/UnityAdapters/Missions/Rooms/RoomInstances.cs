...
namespace ShooterMover.UnityAdapters.Missions.Rooms
{
    ...
    /// either directly to an IEnemyState component or to a component exposing
    /// one through a public Authority property. No enemy package names are inspected.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class EnemyDeathSource : MonoBehaviour
    {
        ...
        public bool TryBind()
        {
            ...
            for (int index = 0; index < components.Length; index++)
            {
                ...
                IEnemyState direct = component as IEnemyState;
                if (direct != null)
                {
                ...
                IEnemyState nested =
                    property.GetValue(component, null) as IEnemyState;
        ...
        private void Bind(Component owner, IEnemyState boundAuthority)
        {
    ...
    [DisallowMultipleComponent]
    public sealed class RoomEnemyDeathRelay : MonoBehaviour
    {
        private RoomObjectInstance placedInstance;
        private EnemyDeathSource terminalSource;
        ...
        public void Configure(
            RoomObjectInstance configuredPlacedInstance,
            EnemyDeathSource configuredTerminalSource)
        {
            if (IsConfigured)
            {
                throw new InvalidOperationException(
        ...
        public bool PollNow()
        {
            ...
            StableId operationStableId = CreateOperationStableId(
                ...
                sourceGeneration,
                roomGeneration);
            RoomLiveOperationResult result = placedInstance.ReportTerminal(
                operationStableId);

...
namespace ShooterMover.UnityAdapters.Weapons.Live
{
        ...
        IActiveWeaponEquipmentInstanceSource
    {
        ...
        {
            if (slotIndex < 0
                || slotIndex >= PlayerRouteProfilePayload.WeaponSlotCount
    ...
    /// </summary>
    public sealed class InventoryWeaponMountedLive
    {
        public InventoryWeaponMountedLive(
    ...
    /// </summary>
    public sealed class InventoryWeaponLiveSetup : IDisposable
    {
        ...
        private readonly InventoryBackedWeaponExecutionBridge executionAdapter;
        private readonly RouteProfileActiveWeaponSource activeWeaponSource;
        private readonly ReadOnlyCollection<InventoryWeaponMountedLive>
            mountedWeapons;
            ...
            InventoryBackedWeaponExecutionBridge adapter)
        {
            ...
            mountedWeapons = new ReadOnlyCollection<
                InventoryWeaponMountedLive>(
                new List<InventoryWeaponMountedLive>());
        ...
        public InventoryWeaponLiveSetup(
            IInventoryWeaponActorStateSource actorState,
            IEnumerable<InventoryWeaponMountedLive> enabledMounts,
            InventoryBackedWeaponExecutionBridge adapter)
        {
            actorStateSource = actorState
                ?? throw new ArgumentNullException(nameof(actorState));
            ...
            {
                InventoryWeaponMountedLive mount = mounts[index];
                if (mount == null
            ...
            mountedWeapons = new ReadOnlyCollection<
                InventoryWeaponMountedLive>(mounts);
            firingSessionState = WeaponFiringSessionState.Empty;
            pendingDeliveryState = InventoryWeaponPendingDeliveryState.Empty;
            triggerEdgeState = InventoryWeaponTriggerEdgeState.Empty;
        }
        ...
        public IReadOnlyList<InventoryWeaponMountedLive> EnabledMounts
        {
            ...
            out string rejectionCode)
        {
            ...
            InventoryWeaponMountedLive first = mountedWeapons[0];
            ...
            bool publishCandidateEdgeWhenSafe)
        {
            ...
            else
            {
                ...
                {
                    InventoryWeaponMountedLive mount = mountedWeapons[index];
                    try
                    {
        ...
        private static InventoryWeaponFireRequest CreateMountedRequest(
            WeaponActorInstanceId actorId,
            LifecycleGeneration generation,
            InventoryWeaponMountedLive mount,
            int mountOrdinal,

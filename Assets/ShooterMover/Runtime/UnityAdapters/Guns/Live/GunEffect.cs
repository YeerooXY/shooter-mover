...
namespace ShooterMover.UnityAdapters.Guns.Live
{
    ...
    public sealed class GunEffect : MonoBehaviour
    {
        private IGunEffectDescription description;
        ...
        public IGunEffectDescription Description
        {
        ...
        public bool TryConfigure(IGunEffectDescription effect)
        {
            ...
            GunVector2 effectOrigin;
            GunVector2 effectDirection;
            double effectSpeed;
            double effectRange;
        ...
        private void Complete()
        {
                ...
                && dot.PoolDuration > 0d)
            {
                GameObject poolObject = new GameObject(
                    "GunPersistentPool_" + dot.Identity.FireOperationId);
        ...
        private static bool TryReadProjectileTravel(
            ...
            out GunVector2 effectOrigin,
            out GunVector2 effectDirection,

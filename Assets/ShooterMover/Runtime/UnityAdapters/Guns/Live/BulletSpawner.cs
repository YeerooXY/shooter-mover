...
namespace ShooterMover.UnityAdapters.Guns.Live
{
    ...
    public sealed class BulletSource : MonoBehaviour
    {
        public GunActorInstanceId ActorId { get; private set; }
        ...
        public GunDefinitionId GunDefinitionId { get; private set; }
            ...
            GunDefinitionId gunDefinitionId)
        {
            ...
            if (IsBound)
            {
                return ActorId.Equals(actorId)
                    ...
                    && GunDefinitionId.Equals(gunDefinitionId);
            }
        ...
        IInventoryGunEffectBatchSink
    {
        private sealed class BoundGunSource
        {
            ...
            internal GunDefinitionId GunDefinitionId { get; }
        }
            ...
            GunDefinitionId gunDefinitionId)
        {
            ...
            if (gunSources.TryGetValue(key, out existing))
            {
                return existing.MountStableId == mountStableId
                    ...
                    && existing.GunDefinitionId.Equals(gunDefinitionId);
            }
            ...
            InventoryGunEffectBatch batch)
        {
            ...
            for (int index = 0; index < batch.CoreBatch.Effects.Count; index++)
            {
                ...
                {
                    return GunEffectBatchSinkResult.Reject(rejectionCode);
                }
                effects.Add(effect);
            }
        ...
        public void ClearOwnerBullets()
        {
            if (retired) return;
            retired = true;
            var snapshot = new List<Bullet>(activeBullets);
            ...
            out BoundGunSource resolved)
        {
            ...
            if (identity == null
                ...
                || !resolved.GunDefinitionId.Equals(
        ...
        private static string FireKey(GunEffectIdentity identity)
        {
            ...
            out string rejectionCode)
        {
            ...
            if (effect.Profile.CanonicalDeliveryType != GunDeliveryType.Normal
            ...
            if (effect.Profile.Guidance == null
                || effect.Profile.Guidance.Mode != GunGuidanceMode.Unguided

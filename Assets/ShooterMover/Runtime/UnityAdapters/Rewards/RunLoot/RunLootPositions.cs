...
namespace ShooterMover.UnityAdapters.Rewards.RunLoots
{
    ...
    public sealed class RunLootPositions : MonoBehaviour,
        IRunLootSourcePositionPort
    {
        private sealed class Registration
        {
            public Registration(
                ...
                RunLootWorldSpawnContext context,
                string fingerprint)
            {
            ...
            public RunLootWorldSpawnContext Context { get; }
            ...
            out string diagnostic)
        {
            ...
            var context = new RunLootWorldSpawnContext(
                roomStableId,
                committedPosition.x,
                committedPosition.y,

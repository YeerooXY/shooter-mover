...
namespace ShooterMover.UnityAdapters.Rewards.Pickups
{
    ...
    public sealed class LootPickupState :
        MonoBehaviour,
        ILootPickupLifecycleState
    {
        ...
        public LootPickupCollectResult Collect(
            ...
            StableId claimantStableId)
        {
            ...
            switch (claim.Status)
            {
                case RewardApplicationResultStatus.Applied:
                    return new LootPickupCollectResult(
                        LootPickupCollectStatus.Collected,
                        claim,
        ...
        private static LootPickupCollectResult AlreadyCollected(
        ...
        private static LootPickupCollectResult Rejected(
            RewardApplicationResult result,
            string diagnostic)
        {

...
namespace ShooterMover.UnityAdapters.Enemies
{
    ...
    public sealed class EnemyTarget2DBridge : MonoBehaviour, IEnemyTarget2DSource
    {
        ...
        public void Configure(
            ...
            IEnemyActor2DState targetAuthority = null)
        {
            ...
            if (configured)
            {
                ...
                throw new InvalidOperationException(
                    "EnemyTarget2DBridge is already configured with different dependencies.");
            }
        ...
        public bool UnregisterFromCombatHits(CombatHit2DBridge hitAdapter)
        {

...
namespace ShooterMover.UnityAdapters.Enemies
{
    ...
    public sealed class EnemyContact2DBridge :
        MonoBehaviour,
        IMovementContact2DContract
    {
        ...
        private EnemyTarget2DBridge enemyTarget;
            ...
            int moverColliderCapacity)
        {
            ...
            if (IsConfigured)
            {
                ...
                throw new InvalidOperationException(
                    "EnemyContact2DBridge is already configured with different dependencies.");
            }
        ...
        public bool Activate()
        {
            ...
            {
                throw new InvalidOperationException(
                    "EnemyContact2DBridge must be configured before activation.");
            }

...
namespace ShooterMover.UnityAdapters.Enemies
{
    ...
    /// </summary>
    public interface IEnemyActor2DState
    {
    ...
    public sealed class EnemyActor2DBridge : MonoBehaviour
    {
        ...
        private EnemyContact2DBridge contactAdapter;
            ...
            double maximumMovementSpeed)
        {
            ...
            if (!actorContactAdapter.IsConfigured)
            {
                throw new InvalidOperationException(
                    "EnemyContact2DBridge must be configured before the actor adapter.");
            }
            ...
            if (IsConfigured)
            {
                ...
                throw new InvalidOperationException(
                    "EnemyActor2DBridge is already configured with different dependencies.");
            }
        ...
        public bool Activate()
        {
            ...
            {
                throw new InvalidOperationException(
                    "EnemyActor2DBridge must be configured before activation.");
            }

...
namespace ShooterMover.UnityAdapters.Enemies
{
    ...
    internal sealed class EnemyBullet : MonoBehaviour
    {
        private EnemyAttack owner;
        private Enemy source;
        private EnemyAttack.PlayerBinding target;
        ...
        public void Bind(
            EnemyAttack configuredOwner,
            Enemy configuredSource,
            EnemyAttack.PlayerBinding configuredTarget,

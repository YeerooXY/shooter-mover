...
namespace ShooterMover.UnityAdapters.Enemies.Presentation
{
    ...
    public sealed class EnemyPart
    {
        ...
        [SerializeField] private EnemyPartParent parent =
            EnemyPartParent.FacingRoot;
        ...
        public EnemyPartParent Parent { get { return parent; } }
        ...
        public bool TryValidate(string path, out string reason)
        {
            ...
            if (!Enum.IsDefined(typeof(EnemyPartParent), parent))
            {
    ...
    public interface IEnemyViewCommands
    {
    ...
    public interface IEnemyReadiness
    {
    ...
    public interface IEnemyDamageReadiness
    {
    ...
    /// <summary>
    /// Presentation-only projection over Enemy. Enemy-specific appearance and
        ...
        IEnemyViewCommands
    {
        ...
        [SerializeField] private EnemyPart[] visualParts =
            Array.Empty<EnemyPart>();
        [SerializeField] private EnemyPart movementMarkerPart;
        [SerializeField] private EnemyPart attackTelegraphPart;
        [SerializeField] private EnemyPart originPulsePart;
        ...
        {
            Enemy actor = GetComponentInParent<Enemy>();
        ...
        private bool TryValidateConfiguration(out string reason)
        {
            ...
            if (!ValidateSpecialPart(
                ...
                || !ValidateSpecialPart(
                    attackTelegraphPart,
                    EnemyPartParent.VisualRoot,
                    "attack telegraph",
                    out reason)
                || !ValidateSpecialPart(
                    originPulsePart,
                    EnemyPartParent.ShotOrigin,
                    "origin pulse",
                    out reason))
            {
                return false;
        ...
        private static bool ValidateSpecialPart(
            EnemyPart definition,
            EnemyPartParent requiredParent,
            string label,
            out string reason)
        {
            if (definition == null)
        ...
        private SpriteRenderer Part(EnemyPart definition)
        {
        ...
        private Transform ResolveParent(EnemyPartParent parent)
        {
            switch (parent)
            {
                case EnemyPartParent.VisualRoot:
                    return visualRoot;
                case EnemyPartParent.FacingRoot:
                    return facingRoot;
                case EnemyPartParent.ShotOrigin:
                    return shotOrigin;
                default:
                    throw new InvalidOperationException(

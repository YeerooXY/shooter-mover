...
{
    public enum EnemyContactRegistrationStatus
    {
        Registered = 1,
        AlreadyRegistered = 2,
        InvalidInput = 3,
    ...
    public enum EnemyContactStatus
    {
        Accepted = 1,
        GraceIgnored = 2,
        DuplicateIgnored = 3,
    ...
    public sealed class EnemyContactApplication
    {
        internal EnemyContactApplication(
            EnemyContactStatus status,
        ...
        public EnemyContactStatus Status { get; }
        ...
        IMovementContact
    {
            ...
            int moverColliderCapacity)
        {
            ...
            if (IsConfigured)
            {
                ...
                throw new InvalidOperationException(
                    "EnemyContact is already configured with different dependencies.");
            }
        ...
        public EnemyContactRegistrationStatus RegisterMoverCollider(
            ...
            CombatWeightClass moverWeight)
        {
            ...
            {
                return EnemyContactRegistrationStatus.InvalidInput;
            }

            if (moverId != expectedMoverId || moverWeight != expectedMoverWeight)
            {
                return EnemyContactRegistrationStatus.Ambiguous;
            }
            ...
            if (moversByInstanceId.TryGetValue(instanceId, out existing))
            {
                ...
                {
                    return EnemyContactRegistrationStatus.AlreadyRegistered;
                }
            ...
            {
                return EnemyContactRegistrationStatus.CapacityReached;
            }

            moversByInstanceId.Add(
                instanceId,
                new MoverBinding(moverCollider, moverId, moverWeight));
            return EnemyContactRegistrationStatus.Registered;
        }
        ...
        public bool Activate()
        {
            ...
            {
                throw new InvalidOperationException(
                    "EnemyContact must be configured before activation.");
            }
        ...
        public EnemyContactApplication TryProcessContact(
            Collider2D moverCollider,
            ...
            double observedAtSeconds)
        {
            if (!IsConfigured)
            {
                return Result(EnemyContactStatus.NotConfigured, null, null, null, null);
            }

            if (!IsActive)
            {
                return Result(EnemyContactStatus.AdapterInactive, null, null, null, null);
            }
            ...
            if (moverCollider == null
                ...
                || currentFixedStep < 0L)
            {
                return Result(EnemyContactStatus.InvalidInput, null, null, null, null);
            }
            ...
            {
                return Result(EnemyContactStatus.UnknownMover, null, null, null, null);
            }
            ...
            try
            {
                ...
                {
                    return Result(
                        EnemyContactStatus.AuthorityUnavailable,
                        null,
                        null,
                        null,
                        null);
            ...
            {
                return Result(EnemyContactStatus.AuthorityUnavailable, null, null, null, null);
            }
            ...
            if (!processedCallbacks.Add(callbackKey))
            {
                ...
                return Result(
                    EnemyContactStatus.DuplicateIgnored,
                    duplicate,
                    weightMessage,
                    null,
                    null);
            ...
            catch (ArgumentException)
            {
                ...
                return Result(EnemyContactStatus.InvalidInput, null, weightMessage, null, null);
            }
            catch (InvalidOperationException)
            {
                processedCallbacks.Remove(callbackKey);
                ...
                || !Enum.IsDefined(typeof(ContactResult), notification.ResultValue))
            {
                processedCallbacks.Remove(callbackKey);
                return Result(
                    EnemyContactStatus.InvalidDomainResult,
                    null,
                    weightMessage,
                    applied,
                    notification);
            ...
            {
                status = EnemyContactStatus.Accepted;
            }
            else if (contactResult == ContactResult.DuplicateEventIgnored)
            {
                status = EnemyContactStatus.DuplicateIgnored;
            }
            else if (contactResult == ContactResult.TargetAlreadyDestroyed)
            {
                status = EnemyContactStatus.TargetAlreadyDestroyed;
            }
            else
            {
                status = EnemyContactStatus.GraceIgnored;
            }
            ...
            try
            {
                ...
                WeightMessage weight = new WeightMessage(
                    ...
                    WeightMessage.DetermineResult(
                        expectedMoverWeight,
                        (CombatWeightClass)state.WeightClassValue));
                descriptor = MovementContactDescriptor.Enemy(state.ActorId, weight);
                return true;
            }
            catch (ArgumentException)
            {
        ...
        private static EnemyContactApplication Result(
            EnemyContactStatus status,
            ContactMessage contactMessage,
            WeightMessage weightMessage,
            EnemyActorStepResult domainResult,
            EnemyContactNotification notification)
        {
            return new EnemyContactApplication(
                status,
                contactMessage,
                weightMessage,
                domainResult,

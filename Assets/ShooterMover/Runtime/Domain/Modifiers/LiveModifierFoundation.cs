...
{
    public enum LiveModifierOperation
    {
        Flat = 1,
        Percentage = 2,
        Multiplicative = 3,
    ...
    /// </summary>
    public sealed class LiveModifierDefinition
    {
        public LiveModifierDefinition(
            string sourceId,
            string targetId,
            ...
            string conditionId = "")
        {
            ...
            if (operation == LiveModifierOperation.Multiplicative
                && value <= 0m)
            {
    ...
    public sealed class LiveModifierEvaluation
    {
        public LiveModifierEvaluation(
            string targetId,
            decimal baseValue,
            decimal unclampedValue,
            decimal finalValue,
            IEnumerable<LiveModifierDefinition> appliedModifiers)
        {
            TargetId = targetId
        ...
        public IReadOnlyList<LiveModifierDefinition> AppliedModifiers
        {
            get;
        }
    ...
    /// </summary>
    public sealed class LiveModifierSnapshot
    {
        public LiveModifierSnapshot(
            IEnumerable<LiveModifierDefinition> modifiers)
        {
            var items = (modifiers
                ?? Array.Empty<LiveModifierDefinition>()).ToList();
            ...
            Modifiers = new ReadOnlyCollection<LiveModifierDefinition>(
        ...
        public IReadOnlyList<LiveModifierDefinition> Modifiers { get; }
            ...
            decimal? maximum = null)
        {
            ...
            List<LiveModifierDefinition> applied = Modifiers
            ...
            return new LiveModifierEvaluation(
                targetId.Trim(),
                baseValue,
                value,
                final,
    ...
    public sealed class FactWindowConditionDefinition
    {
        public FactWindowConditionDefinition(
            string conditionId,
    ...
    internal static class LiveModifierFingerprint
    {

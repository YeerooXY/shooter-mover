...
namespace ShooterMover.Domain.Persistence.Accounts
{
    ...
    public sealed class SaveComponentSnapshot
    {
            ...
            string canonicalPayload)
        {
            ...
            Fingerprint = PlayerAccountSnapshotFingerprint.Hash(
                ToCanonicalString());
        }
    ...
    {
        public CharacterInstanceSnapshot(
    ...
    /// </summary>
    public sealed class PlayerAccountSnapshot
    {
        public const int CharacterSlotCount = 6;
        public const int CurrentSchemaVersion = 1;

        public PlayerAccountSnapshot(
        ...
        public IReadOnlyList<CharacterInstanceSnapshot> CharacterSlots
        {
            get;
        }
        ...
        public CharacterInstanceSnapshot CharacterAt(int slotIndex)
        {
        ...
        public PlayerAccountSnapshot WithCharacter(
            int slotIndex,
        ...
        public PlayerAccountSnapshot WithoutCharacter(int slotIndex)
        {
            ValidateSlotIndex(slotIndex);
            var slots = CharacterSlots.ToArray();
        ...
        public static PlayerAccountSnapshot Empty(StableId accountStableId)
        {
            return new PlayerAccountSnapshot(
                accountStableId,
                0L,
                new CharacterInstanceSnapshot[CharacterSlotCount],
                null);
        }
        ...
        private static IReadOnlyList<CharacterInstanceSnapshot>
                ...
                IEnumerable<CharacterInstanceSnapshot> orderedCharacterSlots)
        {
            ...
            {
                CharacterInstanceSnapshot character = slots[index];
                if (character == null)
                {
                    continue;
                }
    ...
    public static class PlayerAccountSnapshotFingerprint
    {

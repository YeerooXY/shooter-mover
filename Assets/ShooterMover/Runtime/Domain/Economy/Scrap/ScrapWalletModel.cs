...
namespace ShooterMover.Domain.Economy.Scrap
{
    ...
    public enum ScrapMutationKind
    {
        Grant = 1,
        Spend = 2,
    }

    public static class ScrapIdentity
    {
    ...
    public sealed class ScrapProvenance
    {
        public ScrapProvenance(
            ...
            out string rejectionCode)
        {
            ...
            if (!ScrapIdentity.TryGetExpectedSourceKind(
                reasonStableId,
    ...
    public sealed class ScrapTransactionCommand
    {
            ...
            long? expectedSequence = null)
        {
            ...
            _ledgerPayload = ScrapLedgerPayload.BuildCanonical(
                operationStableId,
                authorityStableId,
                mutationKind,
                amount,
            ...
            _canonicalText = "format=scrap-command-v1"
                ...
                + (expectedSequence.HasValue
                    ...
                    : "none");
            _fingerprint = ScrapFingerprint.Compute(_canonicalText);
        }
        ...
        {
            if (!Enum.IsDefined(typeof(ScrapMutationKind), MutationKind)
                || Amount <= 0L)
            {
                return 1L;
            }

            return MutationKind == ScrapMutationKind.Grant
                ? Amount
                : -Amount;
        }
    ...
    public sealed class ScrapLedgerPayload
    {
        ...
        public static bool TryParse(
            string canonicalText,
            out ScrapLedgerPayload payload,
            out string rejectionCode)
        {
            payload = null;
            ...
            var provenance = new ScrapProvenance(
                ...
                subjectStableId);
            var parsed = new ScrapLedgerPayload(
                operationStableId,
                authorityStableId,
                (ScrapMutationKind)kindValue,
                amount,
                reasonStableId,
                provenance,
                canonicalText);
    ...
    public sealed class ScrapSnapshot
    {
        public const int CurrentSchemaVersion = 1;

        public ScrapSnapshot(
            int schemaVersion,
        ...
        public static ScrapSnapshot CreateCanonical(
            StableId authorityStableId,
            StableId currencyStableId,
            long balance,
            LedgerSnapshot<ScrapLedgerVocabulary> ledgerSnapshot)
            ...
            LedgerSnapshot<ScrapLedgerVocabulary> ledgerSnapshot)
        {
            ...
            return ScrapFingerprint.Compute(canonical);
        }
    }

    public static class ScrapFingerprint
    {

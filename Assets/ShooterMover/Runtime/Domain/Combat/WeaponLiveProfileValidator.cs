...
{
    /// <summary>
    /// Structural validation for WeaponLiveProfile v1. These bounds reject malformed
    /// runtime tuning without choosing final balance for any weapon package.
    /// </summary>
    public static class WeaponLiveProfileValidator
    {
        ...
        {
            if (profileVersion != WeaponLiveProfile.CurrentProfileVersion)
            {

...
namespace ShooterMover.Domain.Combat
{
    ...
    /// </summary>
    public sealed class WeaponLiveProfile : IEquatable<WeaponLiveProfile>
    {
        ...
        public static WeaponLiveProfile Create(
            int profileVersion,
            StableId profileId,
            double cadenceSeconds,
            int burstShotCount,
            ...
            int presentationPriority)
        {
            ...
            WeaponLiveProfileValidator.ValidateValues(
                profileVersion,
                profileId,
                cadenceSeconds,
                burstShotCount,
        ...
        public static WeaponLiveProfile ParseCanonical(
            string text,
            IEnumerable<StableId> knownBehaviorModuleIds)
        {
            if (text == null)
            ...
            if (behaviorModuleCount < 0
                || behaviorModuleCount > WeaponLiveProfileValidator.MaximumBehaviorModuleCount)
            {
            ...
            WeaponLiveProfile profile = Create(
        ...
        public bool Equals(WeaponLiveProfile other)
        {
        ...
        {
            return Equals(obj as WeaponLiveProfile);
        }
        ...
        public static bool operator ==(WeaponLiveProfile left, WeaponLiveProfile right)
        {

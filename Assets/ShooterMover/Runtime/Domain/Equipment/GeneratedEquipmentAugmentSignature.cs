...
namespace ShooterMover.Domain.Equipment
{
    ...
    /// </summary>
    public sealed class GeneratedEquipmentAugmentSignature :
        IEquatable<GeneratedEquipmentAugmentSignature>,
        IComparable<GeneratedEquipmentAugmentSignature>
    {
        private readonly string canonicalText;

        public GeneratedEquipmentAugmentSignature(
        ...
        public int CompareTo(GeneratedEquipmentAugmentSignature other)
        {
        ...
        public bool Equals(GeneratedEquipmentAugmentSignature other)
        {
            return !ReferenceEquals(other, null)
                && string.Equals(
                    canonicalText,
        ...
        {
            return Equals(obj as GeneratedEquipmentAugmentSignature);
        }

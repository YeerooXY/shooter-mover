...
{
    public static partial class EnemyCatalogValidator
    {
        private static void ValidateAttacks(
            List<EnemyCatalogIssue> issues,
            string path,
            ...
            int schemaVersion)
        {
            ...
            {
                EnemyAttackCapabilityDescriptor attack = definition.Attacks[index];
                ...
                EnemyAttackCapabilityRegistration registration;
                ...
                {
                    EnemyAttackParameterKinds supplied = attack.ParameterKinds;
                    ...
                    bool onlyAllowed =
                        ...
                        == EnemyAttackParameterKinds.None;
            ...
            EnemyShootingPattern pattern)
        {
            bool valid = pattern.ShotsPerSequence >= 1
                ...
                && IsFiniteInRange(
                    ...
                    MaximumCooldownSeconds,
                    true)
                && Enum.IsDefined(typeof(EnemySequenceAimPolicy), pattern.SequenceAimPolicy)
                && Enum.IsDefined(
        ...
        private static void ValidateMeleePattern(
            ...
            EnemyAttackCapabilityDescriptor attack)
        {
            EnemyMeleePattern pattern = attack.MeleePattern;
            bool valid = pattern != null
                ...
                && Enum.IsDefined(
                    typeof(EnemyMeleeAimCommitPolicy),
                    pattern.AimCommitPolicy)
                && Enum.IsDefined(
                    typeof(EnemyMeleeTerminalOnImpactPolicy),
        ...
        private static void ValidateLegacyProjectile(
            ...
            IEnemyCatalogRegistry registry)
        {
            EnemyProjectileAttackParameters projectile = attack.Projectile;
        ...
        private static void ValidateLegacyMelee(
            ...
            EnemyAttackCapabilityDescriptor attack)
        {
            EnemyMeleeAttackParameters melee = attack.Melee;
        ...
        private static void Add(
            ICollection<EnemyCatalogIssue> issues,
            string code,
            string path,
            string message)
        {
            issues.Add(new EnemyCatalogIssue(code, path, message));
        }
    }
}

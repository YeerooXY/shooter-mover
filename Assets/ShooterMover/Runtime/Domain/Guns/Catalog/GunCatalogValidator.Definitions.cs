...
namespace ShooterMover.Domain.Guns.Catalog
{
    public static partial class GunCatalogValidator
    {
        private static void ValidateDefinitions(
            IList<GunDefinitionData> definitions,
            IDictionary<string, GunFamilyDefinition> families,
            ...
            List<GunCatalogIssue> issues)
        {
            ...
            {
                GunDefinitionData value = definitions[index];
                ...
                {
                    issues.Add(new GunCatalogIssue(
                        GunCatalogIssueCode.DuplicateFamilyMark,
                        path,
                ...
                {
                    issues.Add(new GunCatalogIssue(
                        GunCatalogIssueCode.UnknownFamily,
                        path + ".FamilyId",

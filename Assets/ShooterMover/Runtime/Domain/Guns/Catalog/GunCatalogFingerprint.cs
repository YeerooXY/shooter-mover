...
{
    internal static class GunCatalogFingerprint
    {
        public static string Calculate(GunCatalog catalog)
        {
            ...
            {
                GunArchetypeDefinition value = pair.Value;
            ...
            {
                GunFamilyDefinition value = catalog.Families[index];
        ...
        private static void AppendRules(StringBuilder builder, GunCatalogRules value)
        {
        ...
        private static void AppendInputs(StringBuilder builder, GunCatalogInputs value)
        {
        ...
        private static void AppendDefinition(StringBuilder builder, GunDefinitionData value)
        {

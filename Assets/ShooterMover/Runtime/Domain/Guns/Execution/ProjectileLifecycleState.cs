...
{
    /// <summary>
    /// Immutable projectile lifecycle. GunGuidanceState is the sole direction and target-lock
    ...
    public sealed class ProjectileLifecycleState
    {
        private ProjectileLifecycleState(
            ...
            double speed,
            GunGuidanceState guidance,
            ProjectilePierceState pierce,
            int eventOrdinal,
            GunTargetReference lastTarget,
        ...
        public GunGuidanceState Guidance { get; }
        public GunVector2 Direction { get { return Guidance.Direction; } }
        ...
        public GunTargetReference LastTarget { get; }
        ...
        public static ProjectileLifecycleState Launch(ProjectileLaunchRequest request)
        {
            ...
            return new ProjectileLifecycleState(
                ...
                GunGuidanceState.Create(request.Direction, request.InitialTarget),
        ...
        public ProjectileLifecycleState WithGuidance(GunGuidanceState guidance)
        {
            RequireActive();
            if (guidance == null)
            {
            ...
            ProjectileWallImpactResolution resolution)
        {
            ...
            GunGuidanceState guidance = Guidance.PauseAfterRicochet(
        ...
        private ProjectileLifecycleState Copy(
            GunVector2 position = null,
            double? distanceTravelled = null,
            double? speed = null,
            GunGuidanceState guidance = null,
            ProjectilePierceState pierce = null,
            int? eventOrdinal = null,
            GunTargetReference lastTarget = null,

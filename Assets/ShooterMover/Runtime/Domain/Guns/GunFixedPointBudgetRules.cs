...
namespace ShooterMover.Domain.Guns
{
    ...
    /// </summary>
    public struct GunRicochetCollisionResolution
    {
        internal GunRicochetCollisionResolution(
            bool bounces,
    ...
    /// </summary>
    public static class GunFixedPointBudgetRules
    {
        /// <summary>
        ...
        /// </summary>
        public static GunRicochetCollisionResolution ResolveEligibleRicochetCollision(
            RicochetValue remaining,
            bool fractionalRollSucceeded)
        {
            if (remaining.GuaranteedBounces > 0)
            {
                return new GunRicochetCollisionResolution(
                    true,
                    false,

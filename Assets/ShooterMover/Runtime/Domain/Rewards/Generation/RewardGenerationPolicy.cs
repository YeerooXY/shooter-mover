...
namespace ShooterMover.Domain.Rewards.Generation
{
    ...
    public enum RewardGenerationTraceDecision
    {
        Eligibility = 1,
        WeightedSelection = 2,
        IndependentChance = 3,
    ...
    public sealed class EquipmentGenerationCandidate : IComparable<EquipmentGenerationCandidate>
    {
        private readonly ReadOnlyCollection<StableId> requiredProgressionTags;

        private EquipmentGenerationCandidate(
        ...
        public static EquipmentGenerationCandidate Create(
            StableId equipmentDefinitionId,
            int minimumCharacterLevel,
            int maximumCharacterLevel,
            int minimumRegionLevel,
            ...
            double sourceBias)
        {
            return new EquipmentGenerationCandidate(
        ...
        public int CompareTo(EquipmentGenerationCandidate other)
        {
    ...
    public sealed class EquipmentQualityCandidate : IComparable<EquipmentQualityCandidate>
    {
        private EquipmentQualityCandidate(StableId qualityId, long nominalAvailabilityLevel, ulong weight)
        {
            QualityId = EquipmentGenerationCandidate.RequireId(qualityId, nameof(qualityId));
        ...
        public static EquipmentQualityCandidate Create(StableId qualityId, long nominalAvailabilityLevel, ulong weight)
        {
            return new EquipmentQualityCandidate(qualityId, nominalAvailabilityLevel, weight);
        }

        public int CompareTo(EquipmentQualityCandidate other)
        {
    ...
    public sealed class AugmentGenerationCandidate : IComparable<AugmentGenerationCandidate>
    {
        private AugmentGenerationCandidate(
            StableId augmentDefinitionId,
            int minimumCharacterLevel,
            int maximumCharacterLevel,
            ulong weight)
        {
            AugmentDefinitionId = EquipmentGenerationCandidate.RequireId(augmentDefinitionId, nameof(augmentDefinitionId));
        ...
        public static AugmentGenerationCandidate Create(
            StableId augmentDefinitionId,
            int minimumCharacterLevel,
            int maximumCharacterLevel,
            ulong weight)
        {
            return new AugmentGenerationCandidate(
                augmentDefinitionId,
                minimumCharacterLevel,
                maximumCharacterLevel,
                weight);
        ...
        public int CompareTo(AugmentGenerationCandidate other)
        {
    ...
    public sealed class EquipmentGenerationPolicy
    {
        private readonly ReadOnlyCollection<EquipmentGenerationCandidate> equipmentCandidates;
        private readonly ReadOnlyCollection<EquipmentQualityCandidate> qualityCandidates;
        private readonly ReadOnlyCollection<AugmentGenerationCandidate> augmentCandidates;
        private readonly string canonicalText;

        private EquipmentGenerationPolicy(
            StableId policyId,
            IEnumerable<EquipmentGenerationCandidate> equipmentCandidates,
            IEnumerable<EquipmentQualityCandidate> qualityCandidates,
            IEnumerable<AugmentGenerationCandidate> augmentCandidates,
            ...
            ObsolescenceCurveParameters obsolescence)
        {
            PolicyId = EquipmentGenerationCandidate.RequireId(policyId, nameof(policyId));
            this.equipmentCandidates = CopyUnique(equipmentCandidates, nameof(equipmentCandidates), delegate(EquipmentGenerationCandidate value) { return value.EquipmentDefinitionId; });
            this.qualityCandidates = CopyUnique(qualityCandidates, nameof(qualityCandidates), delegate(EquipmentQualityCandidate value) { return value.QualityId; });
            this.augmentCandidates = CopyUnique(augmentCandidates, nameof(augmentCandidates), delegate(AugmentGenerationCandidate value) { return value.AugmentDefinitionId; });
        ...
        public IReadOnlyList<EquipmentGenerationCandidate> EquipmentCandidates { get { return equipmentCandidates; } }
        public IReadOnlyList<EquipmentQualityCandidate> QualityCandidates { get { return qualityCandidates; } }
        public IReadOnlyList<AugmentGenerationCandidate> AugmentCandidates { get { return augmentCandidates; } }
        ...
        public static EquipmentGenerationPolicy Create(
            StableId policyId,
            IEnumerable<EquipmentGenerationCandidate> equipmentCandidates,
            IEnumerable<EquipmentQualityCandidate> qualityCandidates,
            IEnumerable<AugmentGenerationCandidate> augmentCandidates,
            ...
            ObsolescenceCurveParameters obsolescence)
        {
            return new EquipmentGenerationPolicy(
                policyId,
                equipmentCandidates,
                qualityCandidates,
                augmentCandidates,
    ...
    public sealed class RewardGenerationTraceEntry : IComparable<RewardGenerationTraceEntry>
    {
        public RewardGenerationTraceEntry(
            int ordinal,
            StableId stepId,
            StableId subjectId,
            RewardGenerationTraceDecision decision,
            ...
            string detail)
        {
            ...
            Ordinal = ordinal;
            StepId = EquipmentGenerationCandidate.RequireId(stepId, nameof(stepId));
            SubjectId = EquipmentGenerationCandidate.RequireId(subjectId, nameof(subjectId));
            if (!Enum.IsDefined(typeof(RewardGenerationTraceDecision), decision))
            {
        ...
        public RewardGenerationTraceDecision Decision { get; }
        ...
        public int CompareTo(RewardGenerationTraceEntry other)
        {
    ...
    public sealed class RewardGenerationTrace
    {
        private readonly ReadOnlyCollection<RewardGenerationTraceEntry> entries;
        private readonly string canonicalText;

        public RewardGenerationTrace(
            int algorithmVersion,
            ulong rootSeed,
            string contentFingerprint,
            string contextFingerprint,
            string resultFingerprint,
            IEnumerable<RewardGenerationTraceEntry> entries)
        {
            ...
            List<RewardGenerationTraceEntry> copy = new List<RewardGenerationTraceEntry>(entries ?? throw new ArgumentNullException(nameof(entries)));
            copy.Sort();
            ...
            this.entries = new ReadOnlyCollection<RewardGenerationTraceEntry>(copy);
            canonicalText = BuildCanonicalText();
            Fingerprint = RewardGenerationFingerprint.Compute(canonicalText);
        }
        ...
        public IReadOnlyList<RewardGenerationTraceEntry> Entries { get { return entries; } }
        public string Fingerprint { get; }
        public string ToCanonicalString() { return canonicalText; }
    ...
    public static class RewardGenerationFingerprint
    {

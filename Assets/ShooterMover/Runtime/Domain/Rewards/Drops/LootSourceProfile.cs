...
namespace ShooterMover.Domain.Rewards.Drops
{
    ...
    /// </summary>
    public sealed class LootSourceProfile :
        IEquatable<LootSourceProfile>
    {
        private readonly ReadOnlyCollection<RewardRollGroup> groups;
        private readonly string canonicalText;

        private LootSourceProfile(
        ...
        public static LootSourceProfile Create(
            StableId profileStableId,
            StableId defaultStrongboxTierSelectionProfileId,
            IEnumerable<RewardRollGroup> groups)
        {
            return new LootSourceProfile(
                profileStableId,
                false,
                defaultStrongboxTierSelectionProfileId,
                groups);
        ...
        public static LootSourceProfile CreateExplicitNoDrop(
            StableId profileStableId)
        {
            return new LootSourceProfile(
                profileStableId,
        ...
        public bool Equals(LootSourceProfile other)
        {
        ...
        {
            return Equals(obj as LootSourceProfile);
        }

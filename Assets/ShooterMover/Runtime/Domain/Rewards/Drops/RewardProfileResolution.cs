...
{
    public sealed class RewardProfileResolution :
        IEquatable<RewardProfileResolution>
    {
        ...
        public bool Equals(RewardProfileResolution other)
        {
        ...
        {
            return Equals(obj as RewardProfileResolution);
        }

...
namespace ShooterMover.Domain.Rewards.Strongboxes
{
    ...
    public sealed class StrongboxPowerBudgetPolicy : IEquatable<StrongboxPowerBudgetPolicy>
    {
        ...
        private StrongboxPowerBudgetPolicy(
            int tierLevelBonus,
        ...
        public static StrongboxPowerBudgetPolicy Create(
            int tierLevelBonus,
            int itemLevelStandardDeviationMilli,
            int minimumAugmentSlots,
            int maximumAugmentSlots,
            int augmentSlotStandardDeviationMilli)
        {
            return new StrongboxPowerBudgetPolicy(
                tierLevelBonus,
        ...
        public StrongboxItemLevelRoll RollItemLevel(
            int playerLevel,
            ulong rootSeed,
            ...
            ulong equipmentSlotOrdinal)
        {
            ...
            return new StrongboxItemLevelRoll(
                equipmentSlotOrdinal,
                playerLevel,
                TierLevelBonus,
                meanItemLevel,
        ...
        public StrongboxEquipmentRollPlan RollAugmentSlots(
            ...
            int algorithmVersion)
        {
            ...
            return new StrongboxEquipmentRollPlan(
                itemLevelRoll,
        ...
        public bool Equals(StrongboxPowerBudgetPolicy other)
        {
        ...
        {
            return Equals(obj as StrongboxPowerBudgetPolicy);
        }
    ...
    public sealed class StrongboxItemLevelRoll : IEquatable<StrongboxItemLevelRoll>
    {
        private readonly string canonicalText;

        public StrongboxItemLevelRoll(
            ulong equipmentSlotOrdinal,
            int playerLevel,
            int tierLevelBonus,
            int meanItemLevel,
            ...
            string policyFingerprint)
        {
            ...
            Strongbox.AppendToken(builder, "equipment_slot_ordinal", EquipmentSlotOrdinal.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "player_level", PlayerLevel.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "tier_level_bonus", TierLevelBonus.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "mean_item_level", MeanItemLevel.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "minimum_item_level", MinimumItemLevel.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "maximum_item_level", MaximumItemLevel.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "target_item_level", TargetItemLevel.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "difference_from_mean", DifferenceFromMean.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "item_level_samples_consumed", ItemLevelSamplesConsumed.ToString(CultureInfo.InvariantCulture));
        ...
        public bool Equals(StrongboxItemLevelRoll other)
        {
            return !ReferenceEquals(other, null)
                && string.Equals(canonicalText, other.canonicalText, StringComparison.Ordinal);
        }
        ...
        public override bool Equals(object obj)
        {
            return Equals(obj as StrongboxItemLevelRoll);
        }
    ...
    public sealed class StrongboxEquipmentRollPlan : IEquatable<StrongboxEquipmentRollPlan>
    {
        private readonly string canonicalText;

        public StrongboxEquipmentRollPlan(
            StrongboxItemLevelRoll itemLevelRoll,
            StableId selectedEquipmentDefinitionId,
            int selectedEquipmentMaximumAugmentSlots,
            int effectiveMaximumAugmentSlots,
            ...
            string policyFingerprint)
        {
            ...
            StringBuilder builder = new StringBuilder();
            Strongbox.AppendToken(builder, "item_level_roll", ItemLevelRoll.ToCanonicalString());
            Strongbox.AppendToken(builder, "selected_equipment_definition_id", SelectedEquipmentDefinitionId.ToString());
            Strongbox.AppendToken(builder, "selected_equipment_maximum_augment_slots", SelectedEquipmentMaximumAugmentSlots.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "effective_maximum_augment_slots", EffectiveMaximumAugmentSlots.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "expected_augment_slots_milli", ExpectedAugmentSlotsMilli.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "rolled_augment_slots", RolledAugmentSlots.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "augment_slot_samples_consumed", AugmentSlotSamplesConsumed.ToString(CultureInfo.InvariantCulture));
            Strongbox.AppendToken(builder, "policy_fingerprint", PolicyFingerprint);
            canonicalText = builder.ToString();
            Fingerprint = Strongbox.Fingerprint(canonicalText);
        }

        public StrongboxItemLevelRoll ItemLevelRoll { get; }
        ...
        public bool Equals(StrongboxEquipmentRollPlan other)
        {
            return !ReferenceEquals(other, null)
                && string.Equals(canonicalText, other.canonicalText, StringComparison.Ordinal);
        }
        ...
        public override bool Equals(object obj)
        {
            return Equals(obj as StrongboxEquipmentRollPlan);
        }

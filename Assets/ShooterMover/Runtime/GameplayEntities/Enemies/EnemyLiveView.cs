...
namespace ShooterMover.GameplayEntities.Enemies
{
    ...
    /// </summary>
    public sealed class EnemyLiveView
    {
        public EnemyLiveView(
            GameplayEntityIdentity identity,
            EnemyDefinitionView definition,
        ...
        public EnemyDefinitionView Definition { get; }

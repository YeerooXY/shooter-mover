...
{
    /// <summary>
    /// Owns exactly one BootstrapSetupRoot for the active Bootstrap scene.
    /// Duplicate scene adapters disable and destroy their complete scene root.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class BootstrapSceneBridge : MonoBehaviour
    {
        private static BootstrapSceneBridge activeOwner;

        private BootstrapSetupRoot compositionRoot;
        ...
        private void OnEnable()
        {
            ...
            try
            {
                ...
                compositionRoot = new BootstrapSetupRoot();
        ...
        {
            BootstrapSetupRoot root = compositionRoot;
            compositionRoot = null;

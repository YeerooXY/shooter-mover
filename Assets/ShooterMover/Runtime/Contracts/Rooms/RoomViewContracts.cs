...
namespace ShooterMover.Contracts.Rooms
{
    ...
    public enum RoomViewReadStatus
    {
        Found = 1,
        UnknownKey = 2,
    }
    ...
    /// </summary>
    public sealed class RoomViewIdentity : IEquatable<RoomViewIdentity>
    {
        public RoomViewIdentity(StableId roomId, StableId projectionId)
        {
        ...
        public bool Equals(RoomViewIdentity other)
        {
        ...
        {
            return Equals(obj as RoomViewIdentity);
        }
    ...
    /// </summary>
    public sealed class RoomViewKey : IEquatable<RoomViewKey>
    {
        public RoomViewKey(
            StableId runId,
            StableId roomId,
        ...
        public override bool Equals(object obj)
        {
            return Equals(obj as RoomViewKey);
        }
    ...
    public sealed class RoomConnection : IEquatable<RoomConnection>
    {
        ...
        public bool Connects(RoomViewIdentity room)
        {
            RoomViewIdentity validated = RoomContractFormat.RequireNotNull(room, nameof(room));
            return First.Room.Equals(validated) || Second.Room.Equals(validated);
        }

        public RoomViewIdentity GetOther(RoomViewIdentity room)
        {
            RoomViewIdentity validated = RoomContractFormat.RequireNotNull(room, nameof(room));
    ...
    /// </summary>
    public sealed class RoomViewReadResult<TProjection>
    {
        private RoomViewReadResult(
            RoomViewKey key,
            RoomViewReadStatus status,
            TProjection value)
        {
        ...
        public RoomViewKey Key { get; }

        public RoomViewReadStatus Status { get; }

        public TProjection Value { get; }

        public bool HasValue
        {
            get { return Status == RoomViewReadStatus.Found; }
        }

        public static RoomViewReadResult<TProjection> Found(
            RoomViewKey key,
            TProjection value)
        {
            ...
            return new RoomViewReadResult<TProjection>(
                key,
                RoomViewReadStatus.Found,
                value);
        }

        public static RoomViewReadResult<TProjection> Unknown(RoomViewKey key)
        {
            return new RoomViewReadResult<TProjection>(
                key,
                RoomViewReadStatus.UnknownKey,
                default(TProjection));
        }
    }
    ...
    /// </summary>
    public interface IRoomViewStateReader
    {
        RoomViewReadResult<TProjection> Read<TProjection>(RoomViewKey key);
    }
    ...
    /// </summary>
    public sealed class RoomViewServices
    {
        public RoomViewServices(
            IRoomViewStateReader stateReader,
        ...
        public IRoomViewStateReader StateReader { get; }

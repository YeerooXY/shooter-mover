...
{
    public enum RoomLivePlacementKind
    {
        Enemy = 1,
        Prop = 2,
    }

    public enum RoomSpawnPointKind
    {
        ForwardEntry = 1,
        ReturnEntry = 2,
        Player = 3,
    ...
    public enum RoomCompletionConditionKind
    {
        AlwaysSatisfied = 1,
    ...
    public enum RoomLiveLinkKind
    {
        Room = 1,
        FinalExit = 2,
    }

    public sealed class RoomVector2
    {
        public RoomVector2(double x, double y)
        {
    ...
    {
        public RoomBounds(RoomVector2 center, RoomVector2 size)
        {
        ...
        public RoomVector2 Center { get; }

        public RoomVector2 Size { get; }
    ...
    {
        public RoomSpawnPointDefinition(
            ...
            double localRotationDegrees)
        {
            ...
            if (!Enum.IsDefined(typeof(RoomSpawnPointKind), kind))
            {
        ...
        public RoomSpawnPointKind Kind { get; }
        ...
        {
            builder.Append("{\"id\":");
            RoomLiveJson.AppendString(builder, SpawnPointStableId.ToString());
            builder.Append(",\"kind\":")
    ...
    public sealed class RoomPlacedEntityDefinition
    {
        public RoomPlacedEntityDefinition(
            StableId instanceStableId,
            RoomLivePlacementKind placementKind,
            ...
            double localRotationDegrees)
        {
            ...
            if (!Enum.IsDefined(typeof(RoomLivePlacementKind), placementKind))
            {
        ...
        public RoomLivePlacementKind PlacementKind { get; }
        ...
        internal void AppendCanonicalJson(StringBuilder builder)
        {
            ...
            RoomLiveJson.AppendString(builder, InstanceStableId.ToString());
            builder.Append(",\"placement_kind\":")
                .Append(((int)PlacementKind).ToString(CultureInfo.InvariantCulture))
                .Append(",\"definition_id\":");
            RoomLiveJson.AppendString(builder, DefinitionStableId.ToString());
            builder.Append(",\"presentation_id\":");
            RoomLiveJson.AppendString(builder, PresentationStableId.ToString());
    ...
    public sealed class RoomDoorDefinition
    {
        ...
        {
            builder.Append("{\"instance_id\":");
            RoomLiveJson.AppendString(builder, DoorInstanceStableId.ToString());
            builder.Append(",\"presentation_id\":");
            RoomLiveJson.AppendString(builder, PresentationStableId.ToString());
            builder.Append(",\"exit_id\":");
            RoomLiveJson.AppendString(builder, ExitStableId.ToString());
            builder.Append(",\"required_condition_ids\":[");
            for (int index = 0; index < requiredConditionStableIds.Count; index++)
            {
                if (index != 0) builder.Append(',');
                RoomLiveJson.AppendString(
                    builder,
    ...
    public sealed class RoomExitLinkDefinition
    {
        public RoomExitLinkDefinition(
            StableId exitStableId,
            StableId doorInstanceStableId,
            ...
            StableId targetSpawnPointStableId)
        {
            ...
            DoorInstanceStableId = doorInstanceStableId
                ?? throw new ArgumentNullException(nameof(doorInstanceStableId));
            if (!Enum.IsDefined(typeof(RoomLiveLinkKind), linkKind))
            {
                throw new ArgumentOutOfRangeException(nameof(linkKind));
            }

            if (!Enum.IsDefined(typeof(RoomExitType), exitType))
            {
        ...
        public RoomLiveLinkKind LinkKind { get; }
        ...
        internal void AppendCanonicalJson(StringBuilder builder)
        {
            ...
            RoomLiveJson.AppendNullableStableId(builder, TargetRoomStableId);
            builder.Append(",\"target_spawn_point_id\":");
            RoomLiveJson.AppendNullableStableId(builder, TargetSpawnPointStableId);
            builder.Append('}');
        }
    }

    public sealed class RoomCompletionConditionDefinition
    {
        public RoomCompletionConditionDefinition(
            ...
            bool isRequiredForRoomCompletion)
        {
            ...
            if (!Enum.IsDefined(typeof(RoomCompletionConditionKind), kind))
            {
                throw new ArgumentOutOfRangeException(nameof(kind));
            }

            if (kind == RoomCompletionConditionKind.CollectedDrop)
            {
        ...
        public RoomCompletionConditionKind Kind { get; }
        ...
        {
            builder.Append("{\"id\":");
            RoomLiveJson.AppendString(builder, ConditionStableId.ToString());
            builder.Append(",\"kind\":")
                .Append(((int)Kind).ToString(CultureInfo.InvariantCulture))
                .Append(",\"subject_id\":");
            RoomLiveJson.AppendNullableStableId(builder, SubjectStableId);
    ...
    internal static class RoomLiveJson
    {

...
namespace ShooterMover.Content.Definitions.Rewards.LootDrops
{
    ...
    /// </summary>
    [CreateAssetMenu(
        fileName = "LootDropProfile",
        menuName = "Shooter Mover/Rewards/Gameplay Drop Profile")]
    public sealed class LootDropProfileDefinitionAsset : ScriptableObject
    {
        ...
        public static LootDropProfileDefinitionAsset CreateRuntime(
            string profileId,
            bool explicitNoDrop,
            ...
            ExclusiveRewardGroupAuthoring[] weightedAlternatives)
        {
            LootDropProfileDefinitionAsset asset =
                CreateInstance<LootDropProfileDefinitionAsset>();

...
namespace ShooterMover.Content.Definitions.Missions.Rooms
{
    ...
    /// Compact enemy mappings are generated from validated Content/Enemies definitions.
    /// </summary>
    public static class BuiltInRoomContentObjectCatalog
    {
        public static RoomContentObjectCatalog Create()
        {
            var definitions = new List<RoomContentObjectDefinition>
            {
                Definition(
                    "prop.level1-cover",
            ...
            definitions.AddRange(CompactEnemyRoomObjectRegistry.Create());
            return new RoomContentObjectCatalog(definitions);
        }

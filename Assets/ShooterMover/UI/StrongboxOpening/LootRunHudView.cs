...
namespace ShooterMover.UI.StrongboxOpening
{
    ...
    public sealed class LootRunHudView : MonoBehaviour
    {
        public RunLootTotalsPresentation Projection { get; private set; }
        public void Bind(RunLootTotalsPresentation immutableProjection)
        {

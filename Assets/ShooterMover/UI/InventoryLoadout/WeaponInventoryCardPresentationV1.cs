...
namespace ShooterMover.UI.InventoryLoadout
{
    ...
    /// </summary>
    public sealed class WeaponInventoryCardPresentationV1
    {
        public const string TemporaryImageResourceKey = "blaster_sp";

        private WeaponInventoryCardPresentationV1(
            string displayName,
        ...
        public static bool TryCreate(
            ...
            string definitionId,
            out WeaponInventoryCardPresentationV1 presentation,
            out string rejectionCode)
        {
            ...
            presentation = new WeaponInventoryCardPresentationV1(

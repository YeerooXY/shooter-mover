...
namespace ShooterMover.UI.InventoryLoadout
{
    ...
    public sealed class InventoryLoadoutScreenController :
        MonoBehaviour,
        IHubRouteDestinationBridge
    {
        ...
        private WeaponHoldingsState canonicalWeaponHoldings;
        private InventoryLoadoutState canonicalLoadoutAuthority;
        private WeaponMountLayout canonicalMountLayout;
        private WeaponCatalog canonicalWeaponCatalog;
        private InventoryLoadoutScreenActions legacyService;
        private WeaponInventoryScreenActions canonicalService;
        ...
        public WeaponInventorySnapshot CanonicalSnapshot
        {
        ...
        {
            WeaponInventorySnapshot current =
            ...
            WeaponInventorySnapshot snapshot)
        {
            ...
            WeaponInventoryMount activeMount =
        ...
        private void DrawCanonicalSafety(WeaponEquipmentInstance instance)
        {
            ...
            bool definitionResolved = WeaponCatalogProvider.Current
                ...
                && mark != null;
            WeaponOperationAvailability upgrade =
                WeaponSafetyPolicy.EvaluateGenericUpgrade(
                    true,
                    definitionResolved);
            WeaponOperationAvailability live =
                WeaponSafetyPolicy.EvaluateLiveExecution(
                    instance,
                    definitionResolved);
            WeaponOperationAvailability overclock =
                WeaponSafetyPolicy.EvaluateOverclockInstallation();
        ...
        private void BuildService(PlayerRouteProfilePayload payload)
        {
            ...
            {
                canonicalService =
                    new WeaponInventoryScreenActions(
                        payload,
                        holdingsAuthority,

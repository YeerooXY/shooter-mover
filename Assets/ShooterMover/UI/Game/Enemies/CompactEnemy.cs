...
namespace ShooterMover.UI.Game.Enemies
{
    ...
    public static class CompactEnemyRuntimeBootstrap
    {
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterAssembliesLoaded)]
        private static void Register()
        {
            CompactEnemySceneFactory.Register(
                (gameObject, owner, roomStableId, placement, enemyLevel) =>
                {
                    CompactEnemy runtime = gameObject.AddComponent<CompactEnemy>();
                    runtime.Configure(
                        owner,
                        roomStableId,
                        placement,

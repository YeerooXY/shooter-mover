...
namespace ShooterMover.UI.Game
{
    ...
    public sealed class RewardClaimRecovery : MonoBehaviour
    {
        ...
        private sealed class RecoveryNotice
        {
            ...
            public int AttemptCount;
            public float NextAttemptAt;
            public RewardClaimTransferResultsView Projection;
        }
        ...
        private void Update()
        {
            ...
            RewardClaimLiveRegistry.BindRuntime(
                graph,
                composition);
            ...
            RecoveryAttemptState state)
        {
            ...
            var authority =
                new RewardClaimAtomicState(
                    ...
                    receipts);
            var persistence =
                new RewardClaimPersistence(
                    composition,
                    preparedAuthority,
                    receipts,
                    graph.Character.CharacterInstanceStableId);
            var service =
                new RewardClaimTransferActions(
                    plan,
                    authority,
                    persistence);
            ...
            RewardClaimTransferResultsView projection =
                RewardClaimResultsBridge.Current;
        ...
        private void RetryNoticeNow()
        {
            ...
            {
                RewardClaimTransferResultsView retried;
                RewardClaimResultsBridge.TryRetry(
                    new RetryRewardClaimTransferCommand(
        ...
        {
            RewardClaimResultsOverlay overlay =
                GetComponent<RewardClaimResultsOverlay>();
            if (overlay == null)
            {
                overlay = gameObject.AddComponent<
                    RewardClaimResultsOverlay>();
            }
            overlay.Configure();
        }

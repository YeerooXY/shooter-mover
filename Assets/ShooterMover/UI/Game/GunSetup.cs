...
namespace ShooterMover.UI.Game
{
    ...
    public sealed class GunSetup : MonoBehaviour
    {
        private static GunSetup instance;
        private bool bound;
        ...
        public PlayerGunSource PlayerSource { get; private set; }
        ...
        private void Update()
        {
            ...
            if (!graph.LoadoutRuntime.TryResolveFirstActiveEquippedGun(
                    out exact,
                    out rejectionCode)
                || exact == null)
            {
                Diagnostic = string.IsNullOrWhiteSpace(rejectionCode)
                    ? "gameplay-canonical-first-active-gun-unresolved"
                    : rejectionCode;
                return;
            }
            ...
            PlayerGunSource source =
                marker.GetComponent<PlayerGunSource>()

...
namespace ShooterMover.UI.Game
{
    ...
    /// </summary>
    public static class ReadOnlyResultsBridge
    {
        ...
        private sealed class ReadOnlyContext
        {
            ...
            public ResultsSummary Summary { get; }
        }
    }

    /// <summary>
    /// Read-only Results projection over the exact immutable RUN-001 payload. Opening
    /// requests pass the exact MissionRunStrongboxResult object to the composition root.
    /// </summary>
    ...
    public sealed class Results : MonoBehaviour
    {
        ...
        private MissionResultPayload result;
        private ResultsSummary summary;
        private Func<MissionRunStrongboxResult, bool> openStrongbox;
        ...
        public MissionResultPayload Result { get { return result; } }
        public ResultsSummary Summary { get { return summary; } }

        public MissionRunStrongboxResult LastSelectedStrongbox
        {
            get;
            private set;
        }
        ...
        private void Awake()
        {
            ReadOnlyResultsBridge.TryConfigure(this);
        }

        public void Configure(
            MissionResultPayload result,
            Func<MissionRunStrongboxResult, bool> openStrongbox,
        ...
        public bool OpenExact(MissionRunStrongboxResult strongbox)
        {
            if (inputLocked
                || result == null
                || strongbox == null
        ...
        private void DrawStrongbox(MissionRunStrongboxResult strongbox)
        {

...
namespace ShooterMover.UI.Shop
{
    ...
    public sealed class ShopScreenController : MonoBehaviour
    {
        ...
        private readonly System.Collections.Generic.Dictionary<
            string,
            WeaponArtSpriteResolution> weaponArtCache =
                new System.Collections.Generic.Dictionary<
                    string,
                    WeaponArtSpriteResolution>(
        ...
        private void DrawWeaponArt(ShopScreenStockCard card)
        {
            if (card == null
                || !string.Equals(
                    card.CategoryLabel,
            ...
            if (!WeaponArtReferenceResolver.TryResolve(

...
namespace ShooterMover.UI.ProductionFlow
{
    ...
    public sealed class WeaponGameplayBinding : MonoBehaviour
    {
        private static WeaponGameplayBinding instance;
        private bool bound;
        ...
        public WeaponMark ResolvedMark { get; private set; }
        public PlayerWeaponSource PlayerSource { get; private set; }
        ...
        private static void TryInstall(Scene scene)
        {
            ...
            PlayableLevelController controller =
            ...
            WeaponGameplayBinding existing =
                controller.GetComponent<
                    WeaponGameplayBinding>();
            if (existing == null)
            {
        ...
        private void Update()
        {
            ...
            PlayerWeaponSource source =
                marker.GetComponent<PlayerWeaponSource>()
        ...
        private static bool RouteContainsExact(
            ShooterMover.Contracts.Flow.Session.PlayerRouteProfilePayload route,
            StableId instanceId)
        {

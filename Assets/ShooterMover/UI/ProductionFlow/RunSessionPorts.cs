...
namespace ShooterMover.UI.ProductionFlow
{
    ...
    {
        private readonly RoomLiveSetup2D rooms;
        public PlayableLevelLivePortFactory(RoomLiveSetup2D rooms)
        {
    ...
    internal sealed class SnapshotWeaponRunPort : ImmutableRunLifecyclePort,
        IRunWeaponLivePort
    {
        private readonly IReadOnlyList<StableId> ids;
        public SnapshotWeaponRunPort(long generation, IEnumerable<StableId> ids)
    ...
    {
        private readonly RoomLiveSetup2D rooms;
        public SnapshotRoomRunPort(long generation, RoomLiveSetup2D rooms)

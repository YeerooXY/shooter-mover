...
namespace ShooterMover.UI.ProductionFlow
{
    ...
    public sealed class CollectedRunRewardRecovery : MonoBehaviour
    {
        ...
        private sealed class RecoveryNotice
        {
            ...
            public int AttemptCount;
            public float NextAttemptAt;
            public CollectedRunRewardTransferResultsView Projection;
        }
        ...
        private static void Install()
        {
            ...
            if (flow != null
                && flow.GetComponent<
                    CollectedRunRewardRecovery>() == null)
            {
                flow.gameObject.AddComponent<
                    CollectedRunRewardRecovery>();
            }
        }
        ...
        private void Update()
        {
            ...
            FlowProfileRecord ignoredProfile;
            ...
            CollectedRunRewardLiveRegistry.BindRuntime(
                graph,
                composition);
            ...
            if (!CollectedRunRewardLiveRegistry.TryResolve(
            ...
            RecoveryAttemptState state)
        {
            ...
            var authority =
                new CollectedRunRewardAtomicState(
                    graph,
                    rewardApplication,
                    preparedAuthority,
                    receipts);
            var persistence =
                new CollectedRunRewardPersistence(
                    composition,
                    preparedAuthority,
                    receipts,
                    graph.Character.CharacterInstanceStableId);
            var service =
                new CollectedRunRewardTransferActions(
                    plan,
                    authority,
                    persistence);
            ...
            CollectedRunRewardResultsBridge.Publish(
                prepared,
                result);
            ConfigureResultsOverlay();
            CollectedRunRewardTransferResultsView projection =
                CollectedRunRewardResultsBridge.Current;
        ...
        private void RetryNoticeNow()
        {
            ...
            {
                CollectedRunRewardTransferResultsView retried;
                CollectedRunRewardResultsBridge.TryRetry(
                    new RetryCollectedRunRewardTransferCommand(
        ...
        {
            CollectedRunRewardResultsOverlay overlay =
                GetComponent<CollectedRunRewardResultsOverlay>();
            if (overlay == null)
            {
                overlay = gameObject.AddComponent<
                    CollectedRunRewardResultsOverlay>();
            }
            overlay.Configure();
        }

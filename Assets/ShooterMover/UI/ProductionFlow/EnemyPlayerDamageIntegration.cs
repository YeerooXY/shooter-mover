...
namespace ShooterMover.UI.ProductionFlow
{
    internal static class EnemyPlayerDamageIntegrationInstaller
    {
        ...
        private static void TryInstall(Scene scene)
        {
            ...
            PlayableLevelController controller = null;
            ...
            for (int index = 0; index < roots.Length; index++)
            {
                ...
                PlayableLevelController candidate = roots[index]
    ...
    public sealed class EnemyPlayerDamageIntegration : MonoBehaviour
    {
        ...
        private RoomLiveSetup2D roomRuntime;
            ...
            out string diagnostic)
        {
            ...
            List<RoomLiveSetup2D> rooms =
                FindActiveComponents<RoomLiveSetup2D>(scene);
            if (rooms.Count > 1)
            {
        ...
        private void HandleEnemyHit(EnemyAttack2D publisher, EnemyHit hit)
        {
            if (destroying
                || defeatAccepted
                || publisher == null

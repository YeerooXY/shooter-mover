...
http.createServer(async (req, res) => {
  try {
    ...
    if (requested === "strongbox-simulator.html") {
      body = Buffer.from(body.toString("utf8").replace("</body>", '<script src="strongbox-production.js"></script><script src="strongbox-analysis-ui.js"></script><script src="strongbox-analysis-cleanup.js"></script></body>'));
    }

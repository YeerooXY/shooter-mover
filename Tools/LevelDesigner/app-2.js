...
function renderInspector(){
 ...
 if(sel.entity){
  ...
  if(e.kind==="enemy")specific=`<div class="section"><div class="section-title">Enemy</div>
    ...
    <div class="grid2"><div><label>Level</label><input data-i="level" type="number" min="1" max="100" value="${e.level||1}"></div><div><label>Drop chance %</label><input data-i="dropChance" type="number" min="0" max="100" step=".1" value="${e.dropChance??100}"></div></div>
    ...
    <div class="grid2"><div><label>Drop chance %</label><input data-i="dropChance" type="number" min="0" max="100" step=".1" value="${e.dropChance??0}"></div><div><label>Layer</label><input data-i="layer" value="${esc(e.layer||"default")}"></div></div>
